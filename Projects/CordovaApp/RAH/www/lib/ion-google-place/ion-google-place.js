    ...
    .directive('ionGooglePlace', [
        ...
        function($ionicTemplateLoader, $ionicBackdrop, $q, $timeout, $rootScope, $document) {
            return {
                require: '?ngModel',
                restrict: 'EA',
                template: '<button class="icon ion-ios-location-outline"  readonly="readonly" class="ion-google-place" autocomplete="off" style="color: black;background: transparent;border: none;font-size: 25px;"></button>',
