angular.module('app.config', []) // set option for select box component

    .constant('HOST_CONFIG', {
        'host':'testapp.redimed.com.au', //final server
        'host': '192.168.1.130', // test server
        'port': '3000'
    })
