angular.module('starter.booking', ['starter.booking.services', 'starter.booking.rlobChooseAppointmentCalendar.controller', 'starter.booking.rlobDetailBooking.controller']).config(function($stateProvider) {
    $stateProvider.state('app.chooseAppointmentCalendar', {
