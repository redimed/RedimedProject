...
Bluetooth.prototype.setDiscoveryOneDevice = function(onSuccess, onError)
{
    exec(onSuccess, onError, "Bluetooth", "isDiscoveryOneDevice", []);
}
...
Bluetooth.prototype.resetMiniEcgData = function(onSuccess, onError)
{
    alert('resetMiniEcgData');
    exec(onSuccess, onError, "Bluetooth", "resetMiniEcgData", []);
}
