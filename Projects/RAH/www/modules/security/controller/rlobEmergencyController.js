...
.controller('rlobEmergencyController',function($scope, $state, SecurityService,$ionicLoading,$ionicPopup,$cordovaCamera,$cordovaFileTransfer,HOST_CONFIG,$ionicModal,$http,$timeout,$filter,$cordovaGeolocation,$cordovaInAppBrowser){
        ...
        $scope.insertEmergency = function(FormEmergency){
            ...
            if(!FormEmergency.$invalid){
                ...
                //     });
                    ...
                    //       title: 'Alert',
                    //       template: 'Can not insertEmergency please try again!!'
                    //     });
                    // },5000)
                    ...
                    if (data.status == 'success') {
                       ...
                       //  var alertPopup = $ionicPopup.alert({
                       //    title: 'Alert',
                       //    template: 'Urgent success thank you !'
                       //  });
