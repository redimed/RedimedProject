      ...
      controller: [
        '$scope', function(scope) {
          ...
          scope.setDate = function(newVal) {
            scope.date = newVal != null ? new Date(newVal) : new Date("1995");
           ...
           scope.setDateNow = function(newVal) {
