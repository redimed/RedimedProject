...
.controller('readNFCController',function($scope,WorkerServices,localStorageService, $ionicPopup, $ionicLoading, $timeout,$state,ConfigService,InjuryServices,
  $q,$cordovaInAppBrowser,$cordovaBarcodeScanner,signaling,HOST_CONFIG){
        $scope.receiveData=[];
        $scope.info=[];
