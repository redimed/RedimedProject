module.exports = function(sequelize,DataTypes){
    var item_code_table = sequelize.define('item_code_table',{
        item_code_id: {type:DataTypes.INTEGER(11), primaryKey:true},
        ...
        tableName: 'item_code_table', // đặt tên bảng
        createdAt: 'Creation_date',
        updatedAt: 'Last_update_date'
    });

    return item_code_table;
};