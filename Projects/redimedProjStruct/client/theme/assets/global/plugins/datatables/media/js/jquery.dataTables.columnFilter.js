...
(function ($) {
    ...
    $.fn.columnFilter = function (options) {
        ...
        function fnCreateDateRangeInput(oTable) {
            th.html(_fnRangeLabelPart(0));
            var sFromId = oTable.attr("id") + '_range_from_' + i;
            var from = $('<input type="text" style="width: 90px" class="date_range_filter date-picker"   id="' + sFromId + '" rel="' + i + '"/>');
            //from.datepicker();
            th.append(from);
            th.append(_fnRangeLabelPart(1));
            var sToId = oTable.attr("id") + '_range_to_' + i;
            var to = $('<input type="text" style="width: 90px" class="date_range_filter date-picker"  id="' + sToId + '" rel="' + i + '"/>');
            th.append(to);
            th.append(_fnRangeLabelPart(2));
            ...
            oTable.dataTableExt.afnFiltering.push(
                function (oSettings, aData, iDataIndex) {
                    ...
                    var dStartDatestr = $('#'+sFromId).val();
                    var dStartDate=moment(dStartDatestr, "DD/MM/YYYY");

                    var dEndDatestr = $('#'+sToId).val();
                    var dEndDate=moment(dEndDatestr, "DD/MM/YYYY");

                    if (dStartDatestr == null && dEndDatestr == null) {
                    ...
                    try {
                        ...
                        if (aData[_fnColumnIndex(index)] == null)
                        {

                            return false;
                        }else {

                            dCellDate = moment(aData[_fnColumnIndex(index)], "D/M/YYYY");
                        }
                    ...
                    if (dStartDatestr == "" && dCellDate <= dEndDate) {

                        return true;
                    }
                    else if (dStartDate <= dCellDate && dEndDatestr == "") {
