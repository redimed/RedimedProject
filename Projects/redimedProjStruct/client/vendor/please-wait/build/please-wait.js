...
(function(root, factory) {
  ...
  PleaseWait = (function() {
    ...
    function PleaseWait(options) {
      ...
      if (this.options.backgroundClass != null) {
        // this._loadingElem.style.backgroundColor = this.options.backgroundColor;
        this._loadingElem.className ="pg-loading-screen " + this.options.backgroundClass;
      }
    ...
    PleaseWait.prototype.updateOption = function(option, value) {
      switch (option) {
        case 'backgroundClass':
          return this._loadingElem.className = "pg-loading-screen " + value;
        case 'logo':
