    ...
    .directive("customInput", function() {
        return {
            ...
            link: function(scope, elem, attrs) {
                scope.$watch("customInput", function(newModel, oldModel) {
                    if (typeof newModel !== undefined) {
                        _.forEach(newModel.validation, function(validation) {
                            if (typeof validation !== undefined) {
                                switch (validation.type) {
                                    case "required":
                                        elem.parent().find("label").append("&nbsp<i class='fa fa-star' style='color: #EAC21F'></i>");
                                        break;
                                }
                            }
                        });
                    ...
                    scope.$watch("ngModel", function(newModel, oldModel) {
                        if (typeof scope.customInput !== undefined && typeof scope.customInput.validation !== undefined) {
                            _.forEach(scope.customInput.validation, function(validation) {
                                switch (validation.type) {
                                    case "required":
                                        if (newModel === "" || newModel === undefined || newModel === null) {
                                            elem.parent().find("label").css("color", "#FF0000");
                                        } else {
