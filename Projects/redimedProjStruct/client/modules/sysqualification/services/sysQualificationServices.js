angular.module('app.loggedIn.sysqualification.services', [])

.factory('sysQualificationService', function(Restangular){
	var mdtService = {}
	var mdtApi = Restangular.all('api/meditek/v1/sysqualification/')
