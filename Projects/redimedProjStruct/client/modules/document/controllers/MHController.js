            ...
            if (tempPatient == null || tempPatient === 'undefined') {
                ...
                DocumentService.loadMH(info).then(function (response) {
                    ...
                    $scope.info = {
                        ...
                        patient_id: patient_id,
                        cal_id: cal_id,
                        s1_relationship: data.s1_relationship || null,
                        s1_job_location: data.s1_job_location || null,
                        ...
                        s13_each_date: data.s13_each_date || null,
                        s13_one_date: data.s13_one_date || null,
