angular.module('app.loggedIn.document.QANTASrampbaggage.controllers',[])
    .controller("RampBaggageController",function($scope, $filter, DocumentService, ConfigService, $http, $cookieStore, $state, toastr, $stateParams, localStorageService){
        ...
        $scope.insert = false;
        //function checkQANTAS_RampBaggage : check if patient had this record, load information this record and can be updated by patient
        //input  : patient_id
        ...
        //function submitQANTAS_rampbaggage : push data into server to insert or update database
