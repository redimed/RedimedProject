<form name="FAForm" ng-submit="submitFA(FAForm)" method="post" novalidate>
    <div class="row">
        <div class="col-md-12 ">
            <button type="submit"
            ...
            <a href="/api/document/FA/print-report/{{infoH.CAL_ID}}/{{infoH.PATIENT_ID}}/{{infoH.FA_ID}}"
            ng-disabled="isNew"
                                    ...
                                    <div ng-repeat="detail in line.detail">
                                        ...
                                        {{detail.val1_name}}
                                                                        ...
                                                                        <div ng-if="line.line_isscore1 == 1  && line.score_type1 == 5" class="portlet-body">
                                                                            ...
                                                                            <div class="row" ng-repeat="detail in line.detail" id="totalSum">
                                                                                <div class="col-md-6 col-sm-6">
                                                                                    <label class="bold">{{detail.detail_name}}</label>
                                                                                </div>
                                                                                <div class="col-md-3 col-sm-3">
                                                                                    <label>{{a[line.line_id][detail.summary] =infoL.RATING_VALUE1[detail.summary]}}/4</label>
                                                                                    <input ng-bind="a[line.line_id].rating=line.rating_id1" type="hidden">
                                                                                    </div>
                                                                                    <div class="col-md-3 col-sm-3">
                                                                                        <label>{{infoL.RATE1[detail.summary]}}</label>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="row">
                                                                                    <div class="col-md-6 col-sm-6">
