angular.module('app.loggedIn.document.QANTASgroundsupport.controllers',[])
    .controller("GroundSupportController",function($scope, $filter, DocumentService, ConfigService, $http, $cookieStore, $state, toastr, $stateParams, localStorageService){
        $scope.dateOptions = {
            formatYear: 'yy',
            startingDay: 1
        };
        ...
        function getAge(dateString) {
            ...
            var birthDate = new Date(dateString);//get selectd date
        ...
        $scope.resetForm = function() {
            ...
            $scope.QANTAS_groundsupport.$setPristine();
        }
        ...
        //function checkQANTAS_groundsupport : check if patient had this record, load information this record and can be updated by patient
        //input  : patient_id
        ...
        //function submitQANTAS_groundsupport : push data into server to insert or update database
                ...
                if($scope.insert==true){
                    ...
                    DocumentService.insertQANTAS_groundsupport($scope.info).then(function(response){
                        if(response.status==="success"){
                            ...
                            $state.go('loggedIn.QANTASgroundsupport', null, {
                                'reload': true
                            });
                        }
                        else{
