...
.controller('NewEditSysForms2Controller',function($scope,$state,$stateParams,ngTableParams,SysForms2Service){
    $scope.data=[];
       
    SysForms2Service.getDetailList().then(function(response){
        $scope.data=response;
