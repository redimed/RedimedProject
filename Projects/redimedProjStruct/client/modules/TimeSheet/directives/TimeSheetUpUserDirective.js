        ...
        return {
            ...
            link: function(scope, element, attrs) {
                scope.$watch('ngModel', function(newModel, oldModel) {
                    ...
                    scope.info.USER_ID = USER_ID;
                    scope.info.oldDeptId = DEPARTMENT_ID;
                    scope.info.oldNodeId = NODE_ID;
                    ...
                    TimeSheetService.LoadDepartMent().then(function(response) {
                        if (response.status === "error") {
                            ...
                            scope.info.departmentid = parseInt(DEPARTMENT_ID);
                        } else {
                            //try catch exception
                    ...
                    TimeSheetService.LoadNodeSelect(localStorageService.get("idTreeTimeSheet")).then(function(response) {
                        if (response.status === "error") {
                            ...
                            scope.info.NODE_ID = parseInt(NODE_ID);
                        } else {
                            //catch exception
                    ...
                    scope.loadDept = function() {
                        var infoDept = {};
                        infoDept.DEPARTMENT_ID = scope.info.departmentid;
