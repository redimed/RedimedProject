...
function() {
    ...
    angular.module("ngMap").directive("mapLazyLoad", a)
}(),
function() {
    "use strict";
            ...
            i = function(t, i, a, s) {
                ...
                var l = function(e, r) {
                    ...
                    s.observeAttrSetObj(c, a, i), s.map = i, s.addObjects(s._objects), t.map = i, t.map.scope = t, google.maps.event.addListenerOnce(i, "idle", function() {
                        t.$emit("mapInitialized", i), a.zoomToIncludeMarkers && s.zoomToIncludeMarkers()
                    })
                }, p = r.filter(a),
                    g = r.getOptions(p, t),
...
function() {
    ...
    var e = function(e, t, n, o) {
        var r = o,
            ...
            a = function(e, t, n) {
                e.$observe(t, function(e) {
                    if (e) {
                        var o = r.camelCase("set-" + t),
                            a = r.toOptionValue(e, {
                                key: t
                            });
                        n[o] && (t.match(/center|position/) && "string" == typeof a ? i.getGeoLocation(a).then(function(e) {
                            n[o](e)
                        }) : n[o](a))
                    }
                })
        ...
        this.map = null, this._objects = [], this.addObject = function(e, t) {
            if (this.map) {
                ...
                this.map[e][t.id || n] = t, "infoWindows" != e && t.setMap && t.setMap && t.setMap(this.map), t.centered && t.position && this.map.setCenter(t.position)
        ...
        }, this.getGeoLocation = function(o) {
            var r = e.defer();
            return !o || o.match(/^current/i) ? t.getCurrentPosition().then(function(e) {
            ...
            var o = r.getAttrsToObserve(e);
            Object.keys(o).length;
            for (var i = 0; i < o.length; i++) a(t, o[i], n)
    ...
    e.$inject = ["$q", "NavigatorGeolocation", "GeoCoder", "Attr2Options"], angular.module("ngMap").controller("MapController", e)
}(),
function() {
    "use strict";
