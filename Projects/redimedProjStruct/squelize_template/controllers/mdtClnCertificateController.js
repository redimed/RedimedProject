...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtClnCertificate.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        var Certificate_id = req.body.Certificate_id;
        db.mdtClnCertificate.find({where:{'Certificate_id': Certificate_id}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtClnCertificate.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var Certificate_id = req.body.Certificate_id;
        db.mdtClnCertificate.update(data, {'Certificate_id': Certificate_id})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var Certificate_id = req.body.Certificate_id;
        db.mdtClnCertificate.destroy({'Certificate_id':Certificate_id})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
