...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtApPayment.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtApPayment.find({where:{'PAYMENT_ID': PAYMENT_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtApPayment.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var PAYMENT_ID = req.body.PAYMENT_ID;
        db.mdtApPayment.update(data, {'PAYMENT_ID': PAYMENT_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var PAYMENT_ID = req.body.PAYMENT_ID;
        db.mdtApPayment.destroy({'PAYMENT_ID':PAYMENT_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
