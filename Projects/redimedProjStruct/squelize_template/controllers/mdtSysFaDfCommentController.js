...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtSysFaDfComment.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        var FA_COMMENT_ID = req.body.FA_COMMENT_ID;
        db.mdtSysFaDfComment.find({where:{'FA_COMMENT_ID': FA_COMMENT_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtSysFaDfComment.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var FA_COMMENT_ID = req.body.FA_COMMENT_ID;
        db.mdtSysFaDfComment.update(data, {'FA_COMMENT_ID': FA_COMMENT_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var FA_COMMENT_ID = req.body.FA_COMMENT_ID;
        db.mdtSysFaDfComment.destroy({'FA_COMMENT_ID':FA_COMMENT_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
