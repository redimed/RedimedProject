...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtFaAssetUsed.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        var AssetUsedID = req.body.AssetUsedID;
        db.mdtFaAssetUsed.find({where:{'AssetUsedID': AssetUsedID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtFaAssetUsed.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var AssetUsedID = req.body.AssetUsedID;
        db.mdtFaAssetUsed.update(data, {'AssetUsedID': AssetUsedID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var AssetUsedID = req.body.AssetUsedID;
        db.mdtFaAssetUsed.destroy({'AssetUsedID':AssetUsedID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
