...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtGlFormulaHeader.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtGlFormulaHeader.find({where:{'formula_id': formula_id}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtGlFormulaHeader.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var formula_id = req.body.formula_id;
        db.mdtGlFormulaHeader.update(data, {'formula_id': formula_id})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var formula_id = req.body.formula_id;
        db.mdtGlFormulaHeader.destroy({'formula_id':formula_id})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
