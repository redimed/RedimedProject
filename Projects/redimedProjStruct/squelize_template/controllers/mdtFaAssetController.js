...
module.exports = {
    ...
    postFindById: function(req, res){
        ...
        db.mdtFaAsset.find({where:{'asset_ID': asset_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtFaAsset.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var asset_ID = req.body.asset_ID;
        db.mdtFaAsset.update(data, {'asset_ID': asset_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var asset_ID = req.body.asset_ID;
        db.mdtFaAsset.destroy({'asset_ID':asset_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
