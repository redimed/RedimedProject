...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtGorgonDocCoe.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        var coe_id = req.body.coe_id;
        db.mdtGorgonDocCoe.find({where:{'coe_id': coe_id}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtGorgonDocCoe.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var coe_id = req.body.coe_id;
        db.mdtGorgonDocCoe.update(data, {'coe_id': coe_id})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var coe_id = req.body.coe_id;
        db.mdtGorgonDocCoe.destroy({'coe_id':coe_id})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
