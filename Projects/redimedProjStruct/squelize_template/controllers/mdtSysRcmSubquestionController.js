...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtSysRcmSubquestion.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        var RCM_SUB_ID = req.body.RCM_SUB_ID;
        db.mdtSysRcmSubquestion.find({where:{'RCM_SUB_ID': RCM_SUB_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtSysRcmSubquestion.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var RCM_SUB_ID = req.body.RCM_SUB_ID;
        db.mdtSysRcmSubquestion.update(data, {'RCM_SUB_ID': RCM_SUB_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var RCM_SUB_ID = req.body.RCM_SUB_ID;
        db.mdtSysRcmSubquestion.destroy({'RCM_SUB_ID':RCM_SUB_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
