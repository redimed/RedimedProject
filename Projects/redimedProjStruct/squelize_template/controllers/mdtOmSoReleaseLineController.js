...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtOmSoReleaseLine.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        var SO_RELEASE_LINE_ID = req.body.SO_RELEASE_LINE_ID;
        db.mdtOmSoReleaseLine.find({where:{'SO_RELEASE_LINE_ID': SO_RELEASE_LINE_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtOmSoReleaseLine.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var SO_RELEASE_LINE_ID = req.body.SO_RELEASE_LINE_ID;
        db.mdtOmSoReleaseLine.update(data, {'SO_RELEASE_LINE_ID': SO_RELEASE_LINE_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var SO_RELEASE_LINE_ID = req.body.SO_RELEASE_LINE_ID;
        db.mdtOmSoReleaseLine.destroy({'SO_RELEASE_LINE_ID':SO_RELEASE_LINE_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
