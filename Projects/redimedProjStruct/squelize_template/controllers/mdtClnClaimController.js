...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtClnClaim.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtClnClaim.find({where:{'Claim_id': Claim_id}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtClnClaim.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var Claim_id = req.body.Claim_id;
        db.mdtClnClaim.update(data, {'Claim_id': Claim_id})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var Claim_id = req.body.Claim_id;
        db.mdtClnClaim.destroy({'Claim_id':Claim_id})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
