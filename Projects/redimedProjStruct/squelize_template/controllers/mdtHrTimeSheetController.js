...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtHrTimeSheet.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        var id = req.body.id;
        db.mdtHrTimeSheet.find({where:{'id': id}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtHrTimeSheet.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var id = req.body.id;
        db.mdtHrTimeSheet.update(data, {'id': id})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var id = req.body.id;
        db.mdtHrTimeSheet.destroy({'id':id})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
