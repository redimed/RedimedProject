...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtGorgonAudiometricForm18.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        var GORGON_ID = req.body.GORGON_ID;
        db.mdtGorgonAudiometricForm18.find({where:{'GORGON_ID': GORGON_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtGorgonAudiometricForm18.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var GORGON_ID = req.body.GORGON_ID;
        db.mdtGorgonAudiometricForm18.update(data, {'GORGON_ID': GORGON_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var GORGON_ID = req.body.GORGON_ID;
        db.mdtGorgonAudiometricForm18.destroy({'GORGON_ID':GORGON_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
