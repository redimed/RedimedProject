...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtSysHierarchyNode.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtSysHierarchyNode.find({where:{'NODE_ID': NODE_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtSysHierarchyNode.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var NODE_ID = req.body.NODE_ID;
        db.mdtSysHierarchyNode.update(data, {'NODE_ID': NODE_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var NODE_ID = req.body.NODE_ID;
        db.mdtSysHierarchyNode.destroy({'NODE_ID':NODE_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
