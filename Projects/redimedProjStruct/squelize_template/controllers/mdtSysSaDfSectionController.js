...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtSysSaDfSection.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtSysSaDfSection.find({where:{'SECTION_ID': SECTION_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtSysSaDfSection.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var SECTION_ID = req.body.SECTION_ID;
        db.mdtSysSaDfSection.update(data, {'SECTION_ID': SECTION_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var SECTION_ID = req.body.SECTION_ID;
        db.mdtSysSaDfSection.destroy({'SECTION_ID':SECTION_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
