...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtSysMaDfSubquestion.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        var MA_LINE_SUB_ID = req.body.MA_LINE_SUB_ID;
        db.mdtSysMaDfSubquestion.find({where:{'MA_LINE_SUB_ID': MA_LINE_SUB_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtSysMaDfSubquestion.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var MA_LINE_SUB_ID = req.body.MA_LINE_SUB_ID;
        db.mdtSysMaDfSubquestion.update(data, {'MA_LINE_SUB_ID': MA_LINE_SUB_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var MA_LINE_SUB_ID = req.body.MA_LINE_SUB_ID;
        db.mdtSysMaDfSubquestion.destroy({'MA_LINE_SUB_ID':MA_LINE_SUB_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
