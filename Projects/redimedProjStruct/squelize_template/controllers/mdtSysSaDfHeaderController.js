...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtSysSaDfHeader.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        var SA_ID = req.body.SA_ID;
        db.mdtSysSaDfHeader.find({where:{'SA_ID': SA_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtSysSaDfHeader.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var SA_ID = req.body.SA_ID;
        db.mdtSysSaDfHeader.update(data, {'SA_ID': SA_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var SA_ID = req.body.SA_ID;
        db.mdtSysSaDfHeader.destroy({'SA_ID':SA_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
