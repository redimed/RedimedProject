...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtSysTaxis.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtSysTaxis.find({where:{'TAX_ID': TAX_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtSysTaxis.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var TAX_ID = req.body.TAX_ID;
        db.mdtSysTaxis.update(data, {'TAX_ID': TAX_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var TAX_ID = req.body.TAX_ID;
        db.mdtSysTaxis.destroy({'TAX_ID':TAX_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
