...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtHrFixElement.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        var id = req.body.id;
        db.mdtHrFixElement.find({where:{'id': id}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtHrFixElement.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var id = req.body.id;
        db.mdtHrFixElement.update(data, {'id': id})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var id = req.body.id;
        db.mdtHrFixElement.destroy({'id':id})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
