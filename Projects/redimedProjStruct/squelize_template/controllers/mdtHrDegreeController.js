...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtHrDegree.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtHrDegree.find({where:{'DEGREE_ID': DEGREE_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtHrDegree.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var DEGREE_ID = req.body.DEGREE_ID;
        db.mdtHrDegree.update(data, {'DEGREE_ID': DEGREE_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var DEGREE_ID = req.body.DEGREE_ID;
        db.mdtHrDegree.destroy({'DEGREE_ID':DEGREE_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
