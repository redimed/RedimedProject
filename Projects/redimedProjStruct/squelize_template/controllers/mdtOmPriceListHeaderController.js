...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtOmPriceListHeader.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        var PL_HEADER_ID = req.body.PL_HEADER_ID;
        db.mdtOmPriceListHeader.find({where:{'PL_HEADER_ID': PL_HEADER_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtOmPriceListHeader.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var PL_HEADER_ID = req.body.PL_HEADER_ID;
        db.mdtOmPriceListHeader.update(data, {'PL_HEADER_ID': PL_HEADER_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var PL_HEADER_ID = req.body.PL_HEADER_ID;
        db.mdtOmPriceListHeader.destroy({'PL_HEADER_ID':PL_HEADER_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
