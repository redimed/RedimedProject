...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtHrReview.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtHrReview.find({where:{'review_id': review_id}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtHrReview.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var review_id = req.body.review_id;
        db.mdtHrReview.update(data, {'review_id': review_id})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var review_id = req.body.review_id;
        db.mdtHrReview.destroy({'review_id':review_id})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
