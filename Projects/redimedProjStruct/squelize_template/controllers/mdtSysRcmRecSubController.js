...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtSysRcmRecSub.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        var RCM_RC_SUB_ID = req.body.RCM_RC_SUB_ID;
        db.mdtSysRcmRecSub.find({where:{'RCM_RC_SUB_ID': RCM_RC_SUB_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtSysRcmRecSub.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var RCM_RC_SUB_ID = req.body.RCM_RC_SUB_ID;
        db.mdtSysRcmRecSub.update(data, {'RCM_RC_SUB_ID': RCM_RC_SUB_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var RCM_RC_SUB_ID = req.body.RCM_RC_SUB_ID;
        db.mdtSysRcmRecSub.destroy({'RCM_RC_SUB_ID':RCM_RC_SUB_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
