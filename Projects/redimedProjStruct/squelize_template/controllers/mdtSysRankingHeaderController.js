...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtSysRankingHeader.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtSysRankingHeader.find({where:{'RATING_ID': RATING_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtSysRankingHeader.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var RATING_ID = req.body.RATING_ID;
        db.mdtSysRankingHeader.update(data, {'RATING_ID': RATING_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var RATING_ID = req.body.RATING_ID;
        db.mdtSysRankingHeader.destroy({'RATING_ID':RATING_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
