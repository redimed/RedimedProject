...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtSysMaDfHeader.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        var QUEST_DF_ID = req.body.QUEST_DF_ID;
        db.mdtSysMaDfHeader.find({where:{'QUEST_DF_ID': QUEST_DF_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtSysMaDfHeader.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var QUEST_DF_ID = req.body.QUEST_DF_ID;
        db.mdtSysMaDfHeader.update(data, {'QUEST_DF_ID': QUEST_DF_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var QUEST_DF_ID = req.body.QUEST_DF_ID;
        db.mdtSysMaDfHeader.destroy({'QUEST_DF_ID':QUEST_DF_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
