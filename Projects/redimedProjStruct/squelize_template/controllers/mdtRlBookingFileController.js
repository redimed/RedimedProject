...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtRlBookingFile.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtRlBookingFile.find({where:{'FILE_ID': FILE_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtRlBookingFile.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var FILE_ID = req.body.FILE_ID;
        db.mdtRlBookingFile.update(data, {'FILE_ID': FILE_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var FILE_ID = req.body.FILE_ID;
        db.mdtRlBookingFile.destroy({'FILE_ID':FILE_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
