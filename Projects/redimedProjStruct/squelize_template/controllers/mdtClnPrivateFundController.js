...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtClnPrivateFund.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        var PF_id = req.body.PF_id;
        db.mdtClnPrivateFund.find({where:{'PF_id': PF_id}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtClnPrivateFund.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var PF_id = req.body.PF_id;
        db.mdtClnPrivateFund.update(data, {'PF_id': PF_id})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var PF_id = req.body.PF_id;
        db.mdtClnPrivateFund.destroy({'PF_id':PF_id})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
