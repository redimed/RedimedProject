...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtThScript.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        var ID = req.body.ID;
        db.mdtThScript.find({where:{'ID': ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtThScript.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var ID = req.body.ID;
        db.mdtThScript.update(data, {'ID': ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
