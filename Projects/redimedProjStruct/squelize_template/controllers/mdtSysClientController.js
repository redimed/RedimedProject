...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtSysClient.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtSysClient.find({where:{'CLIENT_ID': CLIENT_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtSysClient.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var CLIENT_ID = req.body.CLIENT_ID;
        db.mdtSysClient.update(data, {'CLIENT_ID': CLIENT_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var CLIENT_ID = req.body.CLIENT_ID;
        db.mdtSysClient.destroy({'CLIENT_ID':CLIENT_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
