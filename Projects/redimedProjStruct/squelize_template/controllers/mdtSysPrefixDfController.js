...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtSysPrefixDf.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        var FORM_CODE = req.body.FORM_CODE;
        db.mdtSysPrefixDf.find({where:{'FORM_CODE': FORM_CODE}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtSysPrefixDf.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var FORM_CODE = req.body.FORM_CODE;
        db.mdtSysPrefixDf.update(data, {'FORM_CODE': FORM_CODE})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var FORM_CODE = req.body.FORM_CODE;
        db.mdtSysPrefixDf.destroy({'FORM_CODE':FORM_CODE})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
