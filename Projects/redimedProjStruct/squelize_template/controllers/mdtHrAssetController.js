...
module.exports = {
    ...
    postFindById: function(req, res){
        ...
        db.mdtHrAsset.find({where:{'asset_id': asset_id}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtHrAsset.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var asset_id = req.body.asset_id;
        db.mdtHrAsset.update(data, {'asset_id': asset_id})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var asset_id = req.body.asset_id;
        db.mdtHrAsset.destroy({'asset_id':asset_id})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
