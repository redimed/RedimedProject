...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtClnAppointmentCalendar.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtClnAppointmentCalendar.find({where:{'CAL_ID': CAL_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtClnAppointmentCalendar.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var CAL_ID = req.body.CAL_ID;
        db.mdtClnAppointmentCalendar.update(data, {'CAL_ID': CAL_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var CAL_ID = req.body.CAL_ID;
        db.mdtClnAppointmentCalendar.destroy({'CAL_ID':CAL_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
