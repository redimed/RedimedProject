...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtSymptomsheader.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        var Sym_Id = req.body.Sym_Id;
        db.mdtSymptomsheader.find({where:{'Sym_Id': Sym_Id}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtSymptomsheader.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var Sym_Id = req.body.Sym_Id;
        db.mdtSymptomsheader.update(data, {'Sym_Id': Sym_Id})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var Sym_Id = req.body.Sym_Id;
        db.mdtSymptomsheader.destroy({'Sym_Id':Sym_Id})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
