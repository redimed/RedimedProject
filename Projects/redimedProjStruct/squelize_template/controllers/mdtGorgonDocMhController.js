...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtGorgonDocMh.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtGorgonDocMh.find({where:{'Gorgon_Id': Gorgon_Id}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtGorgonDocMh.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var Gorgon_Id = req.body.Gorgon_Id;
        db.mdtGorgonDocMh.update(data, {'Gorgon_Id': Gorgon_Id})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var Gorgon_Id = req.body.Gorgon_Id;
        db.mdtGorgonDocMh.destroy({'Gorgon_Id':Gorgon_Id})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
