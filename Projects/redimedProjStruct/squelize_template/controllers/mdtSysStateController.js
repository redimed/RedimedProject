...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtSysState.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtSysState.find({where:{'State': State}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtSysState.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var State = req.body.State;
        db.mdtSysState.update(data, {'State': State})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var State = req.body.State;
        db.mdtSysState.destroy({'State':State})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
