...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtSysRcmRecommendation.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        var RCM_RC_ID = req.body.RCM_RC_ID;
        db.mdtSysRcmRecommendation.find({where:{'RCM_RC_ID': RCM_RC_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtSysRcmRecommendation.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var RCM_RC_ID = req.body.RCM_RC_ID;
        db.mdtSysRcmRecommendation.update(data, {'RCM_RC_ID': RCM_RC_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var RCM_RC_ID = req.body.RCM_RC_ID;
        db.mdtSysRcmRecommendation.destroy({'RCM_RC_ID':RCM_RC_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
