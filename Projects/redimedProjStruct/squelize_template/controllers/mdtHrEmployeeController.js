...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtHrEmployee.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtHrEmployee.find({where:{'Employee_ID': Employee_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtHrEmployee.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var Employee_ID = req.body.Employee_ID;
        db.mdtHrEmployee.update(data, {'Employee_ID': Employee_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var Employee_ID = req.body.Employee_ID;
        db.mdtHrEmployee.destroy({'Employee_ID':Employee_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
