...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtFaAssetgroup.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtFaAssetgroup.find({where:{'AssetGroupID': AssetGroupID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtFaAssetgroup.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var AssetGroupID = req.body.AssetGroupID;
        db.mdtFaAssetgroup.update(data, {'AssetGroupID': AssetGroupID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var AssetGroupID = req.body.AssetGroupID;
        db.mdtFaAssetgroup.destroy({'AssetGroupID':AssetGroupID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
