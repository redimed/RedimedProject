...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtSysCalendarHeader.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtSysCalendarHeader.find({where:{'CAL_ID': CAL_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtSysCalendarHeader.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var CAL_ID = req.body.CAL_ID;
        db.mdtSysCalendarHeader.update(data, {'CAL_ID': CAL_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var CAL_ID = req.body.CAL_ID;
        db.mdtSysCalendarHeader.destroy({'CAL_ID':CAL_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
