...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtSysRcmSubquestionsDetail.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        var RCM_SUB_DETAIL_ID = req.body.RCM_SUB_DETAIL_ID;
        db.mdtSysRcmSubquestionsDetail.find({where:{'RCM_SUB_DETAIL_ID': RCM_SUB_DETAIL_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtSysRcmSubquestionsDetail.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var RCM_SUB_DETAIL_ID = req.body.RCM_SUB_DETAIL_ID;
        db.mdtSysRcmSubquestionsDetail.update(data, {'RCM_SUB_DETAIL_ID': RCM_SUB_DETAIL_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var RCM_SUB_DETAIL_ID = req.body.RCM_SUB_DETAIL_ID;
        db.mdtSysRcmSubquestionsDetail.destroy({'RCM_SUB_DETAIL_ID':RCM_SUB_DETAIL_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
