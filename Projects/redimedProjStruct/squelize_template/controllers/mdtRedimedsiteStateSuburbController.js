...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtRedimedsiteStateSuburb.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtRedimedsiteStateSuburb.find({where:{'suburb_id': suburb_id}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtRedimedsiteStateSuburb.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var suburb_id = req.body.suburb_id;
        db.mdtRedimedsiteStateSuburb.update(data, {'suburb_id': suburb_id})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var suburb_id = req.body.suburb_id;
        db.mdtRedimedsiteStateSuburb.destroy({'suburb_id':suburb_id})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
