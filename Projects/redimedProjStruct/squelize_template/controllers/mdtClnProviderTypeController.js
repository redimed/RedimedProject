...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtClnProviderType.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        var Provider_types_id = req.body.Provider_types_id;
        db.mdtClnProviderType.find({where:{'Provider_types_id': Provider_types_id}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtClnProviderType.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var Provider_types_id = req.body.Provider_types_id;
        db.mdtClnProviderType.update(data, {'Provider_types_id': Provider_types_id})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var Provider_types_id = req.body.Provider_types_id;
        db.mdtClnProviderType.destroy({'Provider_types_id':Provider_types_id})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
