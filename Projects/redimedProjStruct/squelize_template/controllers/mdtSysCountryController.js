...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtSysCountry.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtSysCountry.find({where:{'Country_name': Country_name}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtSysCountry.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var Country_name = req.body.Country_name;
        db.mdtSysCountry.update(data, {'Country_name': Country_name})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var Country_name = req.body.Country_name;
        db.mdtSysCountry.destroy({'Country_name':Country_name})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
