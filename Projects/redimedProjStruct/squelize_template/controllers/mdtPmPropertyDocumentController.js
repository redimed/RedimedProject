...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtPmPropertyDocument.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtPmPropertyDocument.find({where:{'doc_id': doc_id}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtPmPropertyDocument.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var doc_id = req.body.doc_id;
        db.mdtPmPropertyDocument.update(data, {'doc_id': doc_id})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var doc_id = req.body.doc_id;
        db.mdtPmPropertyDocument.destroy({'doc_id':doc_id})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
