...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtGorgonDocMa.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtGorgonDocMa.find({where:{'GORGON_ID': GORGON_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtGorgonDocMa.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var GORGON_ID = req.body.GORGON_ID;
        db.mdtGorgonDocMa.update(data, {'GORGON_ID': GORGON_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var GORGON_ID = req.body.GORGON_ID;
        db.mdtGorgonDocMa.destroy({'GORGON_ID':GORGON_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
