...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtGorgonCategory2.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtGorgonCategory2.find({where:{'cat_id': cat_id}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtGorgonCategory2.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var cat_id = req.body.cat_id;
        db.mdtGorgonCategory2.update(data, {'cat_id': cat_id})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var cat_id = req.body.cat_id;
        db.mdtGorgonCategory2.destroy({'cat_id':cat_id})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
