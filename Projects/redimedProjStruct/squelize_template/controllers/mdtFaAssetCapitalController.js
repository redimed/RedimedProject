...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtFaAssetCapital.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        var AssetCapitalID = req.body.AssetCapitalID;
        db.mdtFaAssetCapital.find({where:{'AssetCapitalID': AssetCapitalID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtFaAssetCapital.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var AssetCapitalID = req.body.AssetCapitalID;
        db.mdtFaAssetCapital.update(data, {'AssetCapitalID': AssetCapitalID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var AssetCapitalID = req.body.AssetCapitalID;
        db.mdtFaAssetCapital.destroy({'AssetCapitalID':AssetCapitalID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
