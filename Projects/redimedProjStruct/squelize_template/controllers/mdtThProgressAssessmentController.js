...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtThProgressAssessment.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtThProgressAssessment.find({where:{'progress_id': progress_id}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtThProgressAssessment.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var progress_id = req.body.progress_id;
        db.mdtThProgressAssessment.update(data, {'progress_id': progress_id})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var progress_id = req.body.progress_id;
        db.mdtThProgressAssessment.destroy({'progress_id':progress_id})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
