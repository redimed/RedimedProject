...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtUserquestionnaire.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtUserquestionnaire.find({where:{'Quest_Id': Quest_Id}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtUserquestionnaire.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var Quest_Id = req.body.Quest_Id;
        db.mdtUserquestionnaire.update(data, {'Quest_Id': Quest_Id})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var Quest_Id = req.body.Quest_Id;
        db.mdtUserquestionnaire.destroy({'Quest_Id':Quest_Id})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
