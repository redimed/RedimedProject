...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtSysChartOfAccount.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        var COA_ID = req.body.COA_ID;
        db.mdtSysChartOfAccount.find({where:{'COA_ID': COA_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtSysChartOfAccount.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var COA_ID = req.body.COA_ID;
        db.mdtSysChartOfAccount.update(data, {'COA_ID': COA_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var COA_ID = req.body.COA_ID;
        db.mdtSysChartOfAccount.destroy({'COA_ID':COA_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
