...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtArInvoiceType.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtArInvoiceType.find({where:{'TYPE_ID': TYPE_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtArInvoiceType.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var TYPE_ID = req.body.TYPE_ID;
        db.mdtArInvoiceType.update(data, {'TYPE_ID': TYPE_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var TYPE_ID = req.body.TYPE_ID;
        db.mdtArInvoiceType.destroy({'TYPE_ID':TYPE_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
