...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtThRedimedReferral.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        var ID = req.body.ID;
        db.mdtThRedimedReferral.find({where:{'ID': ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtThRedimedReferral.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var ID = req.body.ID;
        db.mdtThRedimedReferral.update(data, {'ID': ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var ID = req.body.ID;
        db.mdtThRedimedReferral.destroy({'ID':ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
