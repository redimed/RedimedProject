...
module.exports = {
    ...
    postFindById: function(req, res){
        ...
        db.mdtSysSex.find({where:{'Sex': Sex}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtSysSex.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var Sex = req.body.Sex;
        db.mdtSysSex.update(data, {'Sex': Sex})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
