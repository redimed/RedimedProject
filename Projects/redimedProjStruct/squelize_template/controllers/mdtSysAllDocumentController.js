...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtSysAllDocument.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtSysAllDocument.find({where:{'DOC_ID': DOC_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtSysAllDocument.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var DOC_ID = req.body.DOC_ID;
        db.mdtSysAllDocument.update(data, {'DOC_ID': DOC_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var DOC_ID = req.body.DOC_ID;
        db.mdtSysAllDocument.destroy({'DOC_ID':DOC_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
