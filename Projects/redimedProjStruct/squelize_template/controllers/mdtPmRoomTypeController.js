...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtPmRoomType.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtPmRoomType.find({where:{'room_type_id': room_type_id}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtPmRoomType.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var room_type_id = req.body.room_type_id;
        db.mdtPmRoomType.update(data, {'room_type_id': room_type_id})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var room_type_id = req.body.room_type_id;
        db.mdtPmRoomType.destroy({'room_type_id':room_type_id})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
