...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtFaTaisanKemtheo.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtFaTaisanKemtheo.find({where:{'STT': STT}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtFaTaisanKemtheo.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var STT = req.body.STT;
        db.mdtFaTaisanKemtheo.update(data, {'STT': STT})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var STT = req.body.STT;
        db.mdtFaTaisanKemtheo.destroy({'STT':STT})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
