...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtOmQuoteLine.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        var QUOTE_LINE_ID = req.body.QUOTE_LINE_ID;
        db.mdtOmQuoteLine.find({where:{'QUOTE_LINE_ID': QUOTE_LINE_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtOmQuoteLine.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var QUOTE_LINE_ID = req.body.QUOTE_LINE_ID;
        db.mdtOmQuoteLine.update(data, {'QUOTE_LINE_ID': QUOTE_LINE_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var QUOTE_LINE_ID = req.body.QUOTE_LINE_ID;
        db.mdtOmQuoteLine.destroy({'QUOTE_LINE_ID':QUOTE_LINE_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
