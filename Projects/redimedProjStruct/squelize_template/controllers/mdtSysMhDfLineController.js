...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtSysMhDfLine.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        var MH_LINE_ID = req.body.MH_LINE_ID;
        db.mdtSysMhDfLine.find({where:{'MH_LINE_ID': MH_LINE_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtSysMhDfLine.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var MH_LINE_ID = req.body.MH_LINE_ID;
        db.mdtSysMhDfLine.update(data, {'MH_LINE_ID': MH_LINE_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var MH_LINE_ID = req.body.MH_LINE_ID;
        db.mdtSysMhDfLine.destroy({'MH_LINE_ID':MH_LINE_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
