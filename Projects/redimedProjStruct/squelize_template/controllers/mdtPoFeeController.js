...
module.exports = {
    ...
    postFindById: function(req, res){
        ...
        db.mdtPoFee.find({where:{'FEE_ID': FEE_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtPoFee.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var FEE_ID = req.body.FEE_ID;
        db.mdtPoFee.update(data, {'FEE_ID': FEE_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var FEE_ID = req.body.FEE_ID;
        db.mdtPoFee.destroy({'FEE_ID':FEE_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
