...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtClnPatient.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtClnPatient.find({where:{'Patient_id': Patient_id}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtClnPatient.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var Patient_id = req.body.Patient_id;
        db.mdtClnPatient.update(data, {'Patient_id': Patient_id})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var Patient_id = req.body.Patient_id;
        db.mdtClnPatient.destroy({'Patient_id':Patient_id})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
