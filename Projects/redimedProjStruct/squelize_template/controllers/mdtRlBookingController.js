...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtRlBooking.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtRlBooking.find({where:{'BOOKING_ID': BOOKING_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtRlBooking.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var BOOKING_ID = req.body.BOOKING_ID;
        db.mdtRlBooking.update(data, {'BOOKING_ID': BOOKING_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var BOOKING_ID = req.body.BOOKING_ID;
        db.mdtRlBooking.destroy({'BOOKING_ID':BOOKING_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
