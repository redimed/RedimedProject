...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtSymptomscontent.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        var Sym_Content_Id = req.body.Sym_Content_Id;
        db.mdtSymptomscontent.find({where:{'Sym_Content_Id': Sym_Content_Id}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtSymptomscontent.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var Sym_Content_Id = req.body.Sym_Content_Id;
        db.mdtSymptomscontent.update(data, {'Sym_Content_Id': Sym_Content_Id})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var Sym_Content_Id = req.body.Sym_Content_Id;
        db.mdtSymptomscontent.destroy({'Sym_Content_Id':Sym_Content_Id})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
