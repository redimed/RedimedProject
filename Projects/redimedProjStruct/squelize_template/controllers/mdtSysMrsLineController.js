...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtSysMrsLine.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        var MRS_LINE_ID = req.body.MRS_LINE_ID;
        db.mdtSysMrsLine.find({where:{'MRS_LINE_ID': MRS_LINE_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtSysMrsLine.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var MRS_LINE_ID = req.body.MRS_LINE_ID;
        db.mdtSysMrsLine.update(data, {'MRS_LINE_ID': MRS_LINE_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var MRS_LINE_ID = req.body.MRS_LINE_ID;
        db.mdtSysMrsLine.destroy({'MRS_LINE_ID':MRS_LINE_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
