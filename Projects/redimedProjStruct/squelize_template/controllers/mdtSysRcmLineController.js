...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtSysRcmLine.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        var RCM_LINE_ID = req.body.RCM_LINE_ID;
        db.mdtSysRcmLine.find({where:{'RCM_LINE_ID': RCM_LINE_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtSysRcmLine.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var RCM_LINE_ID = req.body.RCM_LINE_ID;
        db.mdtSysRcmLine.update(data, {'RCM_LINE_ID': RCM_LINE_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var RCM_LINE_ID = req.body.RCM_LINE_ID;
        db.mdtSysRcmLine.destroy({'RCM_LINE_ID':RCM_LINE_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
