...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtApBankBranchAccount.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtApBankBranchAccount.find({where:{'BANK_ACCOUNT_ID': BANK_ACCOUNT_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtApBankBranchAccount.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var BANK_ACCOUNT_ID = req.body.BANK_ACCOUNT_ID;
        db.mdtApBankBranchAccount.update(data, {'BANK_ACCOUNT_ID': BANK_ACCOUNT_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var BANK_ACCOUNT_ID = req.body.BANK_ACCOUNT_ID;
        db.mdtApBankBranchAccount.destroy({'BANK_ACCOUNT_ID':BANK_ACCOUNT_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
