...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtPoHeader.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtPoHeader.find({where:{'HEADER_ID': HEADER_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtPoHeader.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var HEADER_ID = req.body.HEADER_ID;
        db.mdtPoHeader.update(data, {'HEADER_ID': HEADER_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var HEADER_ID = req.body.HEADER_ID;
        db.mdtPoHeader.destroy({'HEADER_ID':HEADER_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
