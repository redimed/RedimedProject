...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtSysFaDfLineDetail.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtSysFaDfLineDetail.find({where:{'DETAIL_ID': DETAIL_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtSysFaDfLineDetail.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var DETAIL_ID = req.body.DETAIL_ID;
        db.mdtSysFaDfLineDetail.update(data, {'DETAIL_ID': DETAIL_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var DETAIL_ID = req.body.DETAIL_ID;
        db.mdtSysFaDfLineDetail.destroy({'DETAIL_ID':DETAIL_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
