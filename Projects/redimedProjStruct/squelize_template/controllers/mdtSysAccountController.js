...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtSysAccount.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtSysAccount.find({where:{'ACC_ID': ACC_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtSysAccount.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var ACC_ID = req.body.ACC_ID;
        db.mdtSysAccount.update(data, {'ACC_ID': ACC_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var ACC_ID = req.body.ACC_ID;
        db.mdtSysAccount.destroy({'ACC_ID':ACC_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
