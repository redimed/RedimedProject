...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtSysMhDfHeader.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        var MH_DF_ID = req.body.MH_DF_ID;
        db.mdtSysMhDfHeader.find({where:{'MH_DF_ID': MH_DF_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtSysMhDfHeader.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var MH_DF_ID = req.body.MH_DF_ID;
        db.mdtSysMhDfHeader.update(data, {'MH_DF_ID': MH_DF_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var MH_DF_ID = req.body.MH_DF_ID;
        db.mdtSysMhDfHeader.destroy({'MH_DF_ID':MH_DF_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
