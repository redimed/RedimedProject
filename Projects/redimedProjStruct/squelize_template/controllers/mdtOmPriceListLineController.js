...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtOmPriceListLine.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        var PL_LINE_ID = req.body.PL_LINE_ID;
        db.mdtOmPriceListLine.find({where:{'PL_LINE_ID': PL_LINE_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtOmPriceListLine.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var PL_LINE_ID = req.body.PL_LINE_ID;
        db.mdtOmPriceListLine.update(data, {'PL_LINE_ID': PL_LINE_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var PL_LINE_ID = req.body.PL_LINE_ID;
        db.mdtOmPriceListLine.destroy({'PL_LINE_ID':PL_LINE_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
