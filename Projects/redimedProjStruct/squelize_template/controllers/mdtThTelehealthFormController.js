...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtThTelehealthForm.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        var Id = req.body.Id;
        db.mdtThTelehealthForm.find({where:{'Id': Id}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtThTelehealthForm.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var Id = req.body.Id;
        db.mdtThTelehealthForm.update(data, {'Id': Id})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var Id = req.body.Id;
        db.mdtThTelehealthForm.destroy({'Id':Id})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
