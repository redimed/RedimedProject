...
module.exports = {
    ...
    postFindById: function(req, res){
        ...
        db.mdtGlLine.find({where:{'line_id': line_id}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtGlLine.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var line_id = req.body.line_id;
        db.mdtGlLine.update(data, {'line_id': line_id})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var line_id = req.body.line_id;
        db.mdtGlLine.destroy({'line_id':line_id})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
