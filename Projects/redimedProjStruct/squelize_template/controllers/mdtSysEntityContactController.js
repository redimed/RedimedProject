...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtSysEntityContact.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtSysEntityContact.find({where:{'CONTACT_ID': CONTACT_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtSysEntityContact.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var CONTACT_ID = req.body.CONTACT_ID;
        db.mdtSysEntityContact.update(data, {'CONTACT_ID': CONTACT_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var CONTACT_ID = req.body.CONTACT_ID;
        db.mdtSysEntityContact.destroy({'CONTACT_ID':CONTACT_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
