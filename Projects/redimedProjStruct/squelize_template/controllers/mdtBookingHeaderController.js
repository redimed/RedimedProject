...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtBookingHeader.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtBookingHeader.find({where:{'Booking_id': Booking_id}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtBookingHeader.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var Booking_id = req.body.Booking_id;
        db.mdtBookingHeader.update(data, {'Booking_id': Booking_id})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var Booking_id = req.body.Booking_id;
        db.mdtBookingHeader.destroy({'Booking_id':Booking_id})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
