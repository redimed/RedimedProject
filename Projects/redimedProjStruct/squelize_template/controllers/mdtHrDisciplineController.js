...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtHrDiscipline.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtHrDiscipline.find({where:{'discipline_id': discipline_id}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtHrDiscipline.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var discipline_id = req.body.discipline_id;
        db.mdtHrDiscipline.update(data, {'discipline_id': discipline_id})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var discipline_id = req.body.discipline_id;
        db.mdtHrDiscipline.destroy({'discipline_id':discipline_id})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
