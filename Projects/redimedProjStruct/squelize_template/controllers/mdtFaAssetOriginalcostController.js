...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtFaAssetOriginalcost.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtFaAssetOriginalcost.find({where:{'TransactionID': TransactionID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtFaAssetOriginalcost.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var TransactionID = req.body.TransactionID;
        db.mdtFaAssetOriginalcost.update(data, {'TransactionID': TransactionID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var TransactionID = req.body.TransactionID;
        db.mdtFaAssetOriginalcost.destroy({'TransactionID':TransactionID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
