...
module.exports = {
    ...
    postFindById: function(req, res){
        ...
        db.mdtPkKey.find({where:{'TABLE_NAME': TABLE_NAME}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtPkKey.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var TABLE_NAME = req.body.TABLE_NAME;
        db.mdtPkKey.update(data, {'TABLE_NAME': TABLE_NAME})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var TABLE_NAME = req.body.TABLE_NAME;
        db.mdtPkKey.destroy({'TABLE_NAME':TABLE_NAME})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
