...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtSysPhisicalDocStorage.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        var STORAGE_ID = req.body.STORAGE_ID;
        db.mdtSysPhisicalDocStorage.find({where:{'STORAGE_ID': STORAGE_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtSysPhisicalDocStorage.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var STORAGE_ID = req.body.STORAGE_ID;
        db.mdtSysPhisicalDocStorage.update(data, {'STORAGE_ID': STORAGE_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var STORAGE_ID = req.body.STORAGE_ID;
        db.mdtSysPhisicalDocStorage.destroy({'STORAGE_ID':STORAGE_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
