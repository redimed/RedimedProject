...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtSysRcmHeader.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        var RCM_DF_ID = req.body.RCM_DF_ID;
        db.mdtSysRcmHeader.find({where:{'RCM_DF_ID': RCM_DF_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtSysRcmHeader.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var RCM_DF_ID = req.body.RCM_DF_ID;
        db.mdtSysRcmHeader.update(data, {'RCM_DF_ID': RCM_DF_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var RCM_DF_ID = req.body.RCM_DF_ID;
        db.mdtSysRcmHeader.destroy({'RCM_DF_ID':RCM_DF_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
