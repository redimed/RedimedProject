...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtFaTransaction.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtFaTransaction.find({where:{'TransactionID': TransactionID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtFaTransaction.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var TransactionID = req.body.TransactionID;
        db.mdtFaTransaction.update(data, {'TransactionID': TransactionID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var TransactionID = req.body.TransactionID;
        db.mdtFaTransaction.destroy({'TransactionID':TransactionID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
