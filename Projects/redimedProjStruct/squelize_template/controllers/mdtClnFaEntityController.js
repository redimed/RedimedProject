...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtClnFaEntity.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtClnFaEntity.find({where:{'ENTITY_ID': ENTITY_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtClnFaEntity.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var ENTITY_ID = req.body.ENTITY_ID;
        db.mdtClnFaEntity.update(data, {'ENTITY_ID': ENTITY_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var ENTITY_ID = req.body.ENTITY_ID;
        db.mdtClnFaEntity.destroy({'ENTITY_ID':ENTITY_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
