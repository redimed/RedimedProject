...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtSysCompanieSite.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtSysCompanieSite.find({where:{'SITE_ID': SITE_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtSysCompanieSite.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var SITE_ID = req.body.SITE_ID;
        db.mdtSysCompanieSite.update(data, {'SITE_ID': SITE_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var SITE_ID = req.body.SITE_ID;
        db.mdtSysCompanieSite.destroy({'SITE_ID':SITE_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
