...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtClnReferringDoctor.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtClnReferringDoctor.find({where:{'REF_ID': REF_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtClnReferringDoctor.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var REF_ID = req.body.REF_ID;
        db.mdtClnReferringDoctor.update(data, {'REF_ID': REF_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var REF_ID = req.body.REF_ID;
        db.mdtClnReferringDoctor.destroy({'REF_ID':REF_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
