...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtSysMhDfGroup.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtSysMhDfGroup.find({where:{'GROUP_ID': GROUP_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtSysMhDfGroup.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var GROUP_ID = req.body.GROUP_ID;
        db.mdtSysMhDfGroup.update(data, {'GROUP_ID': GROUP_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var GROUP_ID = req.body.GROUP_ID;
        db.mdtSysMhDfGroup.destroy({'GROUP_ID':GROUP_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
