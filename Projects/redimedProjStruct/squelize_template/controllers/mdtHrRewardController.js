...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtHrReward.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtHrReward.find({where:{'reward_id': reward_id}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtHrReward.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var reward_id = req.body.reward_id;
        db.mdtHrReward.update(data, {'reward_id': reward_id})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var reward_id = req.body.reward_id;
        db.mdtHrReward.destroy({'reward_id':reward_id})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
