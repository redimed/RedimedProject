...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtSysIdasLine.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        var IDAS_LINE_ID = req.body.IDAS_LINE_ID;
        db.mdtSysIdasLine.find({where:{'IDAS_LINE_ID': IDAS_LINE_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtSysIdasLine.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var IDAS_LINE_ID = req.body.IDAS_LINE_ID;
        db.mdtSysIdasLine.update(data, {'IDAS_LINE_ID': IDAS_LINE_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var IDAS_LINE_ID = req.body.IDAS_LINE_ID;
        db.mdtSysIdasLine.destroy({'IDAS_LINE_ID':IDAS_LINE_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
