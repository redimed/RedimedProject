...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtSysMhDfLineSubquestion.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        var MH_LINE_SUB_ID = req.body.MH_LINE_SUB_ID;
        db.mdtSysMhDfLineSubquestion.find({where:{'MH_LINE_SUB_ID': MH_LINE_SUB_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtSysMhDfLineSubquestion.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var MH_LINE_SUB_ID = req.body.MH_LINE_SUB_ID;
        db.mdtSysMhDfLineSubquestion.update(data, {'MH_LINE_SUB_ID': MH_LINE_SUB_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var MH_LINE_SUB_ID = req.body.MH_LINE_SUB_ID;
        db.mdtSysMhDfLineSubquestion.destroy({'MH_LINE_SUB_ID':MH_LINE_SUB_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
