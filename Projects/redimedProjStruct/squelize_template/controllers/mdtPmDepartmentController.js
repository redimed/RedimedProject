...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtPmDepartment.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtPmDepartment.find({where:{'dept_id': dept_id}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtPmDepartment.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var dept_id = req.body.dept_id;
        db.mdtPmDepartment.update(data, {'dept_id': dept_id})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var dept_id = req.body.dept_id;
        db.mdtPmDepartment.destroy({'dept_id':dept_id})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
