...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtApInvoiceLine.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        var INVOICE_LINE_ID = req.body.INVOICE_LINE_ID;
        db.mdtApInvoiceLine.find({where:{'INVOICE_LINE_ID': INVOICE_LINE_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtApInvoiceLine.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var INVOICE_LINE_ID = req.body.INVOICE_LINE_ID;
        db.mdtApInvoiceLine.update(data, {'INVOICE_LINE_ID': INVOICE_LINE_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var INVOICE_LINE_ID = req.body.INVOICE_LINE_ID;
        db.mdtApInvoiceLine.destroy({'INVOICE_LINE_ID':INVOICE_LINE_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
