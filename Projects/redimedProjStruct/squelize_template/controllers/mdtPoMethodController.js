...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtPoMethod.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        var PO_METHOD_ID = req.body.PO_METHOD_ID;
        db.mdtPoMethod.find({where:{'PO_METHOD_ID': PO_METHOD_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtPoMethod.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var PO_METHOD_ID = req.body.PO_METHOD_ID;
        db.mdtPoMethod.update(data, {'PO_METHOD_ID': PO_METHOD_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var PO_METHOD_ID = req.body.PO_METHOD_ID;
        db.mdtPoMethod.destroy({'PO_METHOD_ID':PO_METHOD_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
