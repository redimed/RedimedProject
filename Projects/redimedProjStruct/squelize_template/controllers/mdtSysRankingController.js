...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtSysRanking.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        var ID = req.body.ID;
        db.mdtSysRanking.find({where:{'ID': ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtSysRanking.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var ID = req.body.ID;
        db.mdtSysRanking.update(data, {'ID': ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var ID = req.body.ID;
        db.mdtSysRanking.destroy({'ID':ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
