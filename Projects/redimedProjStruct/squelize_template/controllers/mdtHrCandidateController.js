...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtHrCandidate.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtHrCandidate.find({where:{'Candidate_ID': Candidate_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtHrCandidate.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var Candidate_ID = req.body.Candidate_ID;
        db.mdtHrCandidate.update(data, {'Candidate_ID': Candidate_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var Candidate_ID = req.body.Candidate_ID;
        db.mdtHrCandidate.destroy({'Candidate_ID':Candidate_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
