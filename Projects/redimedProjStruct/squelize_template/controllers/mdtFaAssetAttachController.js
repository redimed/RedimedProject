...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtFaAssetAttach.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        var AssetAttachID = req.body.AssetAttachID;
        db.mdtFaAssetAttach.find({where:{'AssetAttachID': AssetAttachID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtFaAssetAttach.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var AssetAttachID = req.body.AssetAttachID;
        db.mdtFaAssetAttach.update(data, {'AssetAttachID': AssetAttachID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var AssetAttachID = req.body.AssetAttachID;
        db.mdtFaAssetAttach.destroy({'AssetAttachID':AssetAttachID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
