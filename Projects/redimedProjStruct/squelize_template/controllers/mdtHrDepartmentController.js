...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtHrDepartment.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        var DEPT_ID_department = req.body.DEPT_ID_department;
        db.mdtHrDepartment.find({where:{'DEPT_ID_department': DEPT_ID_department}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtHrDepartment.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var DEPT_ID_department = req.body.DEPT_ID_department;
        db.mdtHrDepartment.update(data, {'DEPT_ID_department': DEPT_ID_department})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var DEPT_ID_department = req.body.DEPT_ID_department;
        db.mdtHrDepartment.destroy({'DEPT_ID_department':DEPT_ID_department})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
