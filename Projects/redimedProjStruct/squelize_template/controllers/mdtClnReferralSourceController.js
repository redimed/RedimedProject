...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtClnReferralSource.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtClnReferralSource.find({where:{'RS_id': RS_id}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtClnReferralSource.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var RS_id = req.body.RS_id;
        db.mdtClnReferralSource.update(data, {'RS_id': RS_id})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var RS_id = req.body.RS_id;
        db.mdtClnReferralSource.destroy({'RS_id':RS_id})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
