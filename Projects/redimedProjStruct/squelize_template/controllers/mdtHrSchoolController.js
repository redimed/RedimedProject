...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtHrSchool.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtHrSchool.find({where:{'School_ID': School_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtHrSchool.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var School_ID = req.body.School_ID;
        db.mdtHrSchool.update(data, {'School_ID': School_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var School_ID = req.body.School_ID;
        db.mdtHrSchool.destroy({'School_ID':School_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
