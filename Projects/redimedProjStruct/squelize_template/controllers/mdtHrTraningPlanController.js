...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtHrTraningPlan.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtHrTraningPlan.find({where:{'plan_id': plan_id}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtHrTraningPlan.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var plan_id = req.body.plan_id;
        db.mdtHrTraningPlan.update(data, {'plan_id': plan_id})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var plan_id = req.body.plan_id;
        db.mdtHrTraningPlan.destroy({'plan_id':plan_id})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
