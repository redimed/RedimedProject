...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtSysCompany.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtSysCompany.find({where:{'COMPANY_ID': COMPANY_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtSysCompany.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var COMPANY_ID = req.body.COMPANY_ID;
        db.mdtSysCompany.update(data, {'COMPANY_ID': COMPANY_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var COMPANY_ID = req.body.COMPANY_ID;
        db.mdtSysCompany.destroy({'COMPANY_ID':COMPANY_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
