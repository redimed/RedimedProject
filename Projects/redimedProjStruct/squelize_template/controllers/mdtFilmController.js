...
module.exports = {
    ...
    postFindById: function(req, res){
        ...
        db.mdtFilm.find({where:{'film_id': film_id}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtFilm.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var film_id = req.body.film_id;
        db.mdtFilm.update(data, {'film_id': film_id})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var film_id = req.body.film_id;
        db.mdtFilm.destroy({'film_id':film_id})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
