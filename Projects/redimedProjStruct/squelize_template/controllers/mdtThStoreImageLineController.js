...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtThStoreImageLine.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtThStoreImageLine.find({where:{'LINE_ID': LINE_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtThStoreImageLine.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var LINE_ID = req.body.LINE_ID;
        db.mdtThStoreImageLine.update(data, {'LINE_ID': LINE_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var LINE_ID = req.body.LINE_ID;
        db.mdtThStoreImageLine.destroy({'LINE_ID':LINE_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
