...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtSysMaDfLine.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        var MA_LINE_ID = req.body.MA_LINE_ID;
        db.mdtSysMaDfLine.find({where:{'MA_LINE_ID': MA_LINE_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtSysMaDfLine.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var MA_LINE_ID = req.body.MA_LINE_ID;
        db.mdtSysMaDfLine.update(data, {'MA_LINE_ID': MA_LINE_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var MA_LINE_ID = req.body.MA_LINE_ID;
        db.mdtSysMaDfLine.destroy({'MA_LINE_ID':MA_LINE_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
