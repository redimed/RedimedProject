...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtSysCasualCalendar.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        var CASUAL_CAL_ID = req.body.CASUAL_CAL_ID;
        db.mdtSysCasualCalendar.find({where:{'CASUAL_CAL_ID': CASUAL_CAL_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtSysCasualCalendar.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var CASUAL_CAL_ID = req.body.CASUAL_CAL_ID;
        db.mdtSysCasualCalendar.update(data, {'CASUAL_CAL_ID': CASUAL_CAL_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var CASUAL_CAL_ID = req.body.CASUAL_CAL_ID;
        db.mdtSysCasualCalendar.destroy({'CASUAL_CAL_ID':CASUAL_CAL_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
