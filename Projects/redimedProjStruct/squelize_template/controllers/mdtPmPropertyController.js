...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtPmProperty.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtPmProperty.find({where:{'property_id': property_id}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtPmProperty.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var property_id = req.body.property_id;
        db.mdtPmProperty.update(data, {'property_id': property_id})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var property_id = req.body.property_id;
        db.mdtPmProperty.destroy({'property_id':property_id})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
