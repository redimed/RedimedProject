...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtApBankBranch.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        var BANK_BRANCH_ID = req.body.BANK_BRANCH_ID;
        db.mdtApBankBranch.find({where:{'BANK_BRANCH_ID': BANK_BRANCH_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtApBankBranch.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var BANK_BRANCH_ID = req.body.BANK_BRANCH_ID;
        db.mdtApBankBranch.update(data, {'BANK_BRANCH_ID': BANK_BRANCH_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var BANK_BRANCH_ID = req.body.BANK_BRANCH_ID;
        db.mdtApBankBranch.destroy({'BANK_BRANCH_ID':BANK_BRANCH_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
