...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtClnApptItem.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        var appt_item_id = req.body.appt_item_id;
        db.mdtClnApptItem.find({where:{'appt_item_id': appt_item_id}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtClnApptItem.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var appt_item_id = req.body.appt_item_id;
        db.mdtClnApptItem.update(data, {'appt_item_id': appt_item_id})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var appt_item_id = req.body.appt_item_id;
        db.mdtClnApptItem.destroy({'appt_item_id':appt_item_id})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
