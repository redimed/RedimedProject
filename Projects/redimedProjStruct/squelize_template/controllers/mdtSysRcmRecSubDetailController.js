...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtSysRcmRecSubDetail.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        var RCM_RC_DETAIL_ID = req.body.RCM_RC_DETAIL_ID;
        db.mdtSysRcmRecSubDetail.find({where:{'RCM_RC_DETAIL_ID': RCM_RC_DETAIL_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtSysRcmRecSubDetail.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var RCM_RC_DETAIL_ID = req.body.RCM_RC_DETAIL_ID;
        db.mdtSysRcmRecSubDetail.update(data, {'RCM_RC_DETAIL_ID': RCM_RC_DETAIL_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var RCM_RC_DETAIL_ID = req.body.RCM_RC_DETAIL_ID;
        db.mdtSysRcmRecSubDetail.destroy({'RCM_RC_DETAIL_ID':RCM_RC_DETAIL_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
