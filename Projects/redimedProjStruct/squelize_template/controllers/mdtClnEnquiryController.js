...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtClnEnquiry.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtClnEnquiry.find({where:{'enquiry_id': enquiry_id}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtClnEnquiry.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var enquiry_id = req.body.enquiry_id;
        db.mdtClnEnquiry.update(data, {'enquiry_id': enquiry_id})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var enquiry_id = req.body.enquiry_id;
        db.mdtClnEnquiry.destroy({'enquiry_id':enquiry_id})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
