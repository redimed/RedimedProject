...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtRedimedsiteState.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtRedimedsiteState.find({where:{'state_id': state_id}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtRedimedsiteState.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var state_id = req.body.state_id;
        db.mdtRedimedsiteState.update(data, {'state_id': state_id})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var state_id = req.body.state_id;
        db.mdtRedimedsiteState.destroy({'state_id':state_id})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
