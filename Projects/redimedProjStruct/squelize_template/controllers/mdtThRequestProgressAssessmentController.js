...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtThRequestProgressAssessment.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtThRequestProgressAssessment.find({where:{'req_id': req_id}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtThRequestProgressAssessment.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var req_id = req.body.req_id;
        db.mdtThRequestProgressAssessment.update(data, {'req_id': req_id})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var req_id = req.body.req_id;
        db.mdtThRequestProgressAssessment.destroy({'req_id':req_id})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
