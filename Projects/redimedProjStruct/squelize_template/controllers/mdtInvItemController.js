...
module.exports = {
    ...
    postFindById: function(req, res){
        ...
        db.mdtInvItem.find({where:{'ITEM_ID': ITEM_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtInvItem.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var ITEM_ID = req.body.ITEM_ID;
        db.mdtInvItem.update(data, {'ITEM_ID': ITEM_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var ITEM_ID = req.body.ITEM_ID;
        db.mdtInvItem.destroy({'ITEM_ID':ITEM_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
