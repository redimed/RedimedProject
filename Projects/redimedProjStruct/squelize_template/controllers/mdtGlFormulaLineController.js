...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtGlFormulaLine.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtGlFormulaLine.find({where:{'formula_line_id': formula_line_id}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtGlFormulaLine.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var formula_line_id = req.body.formula_line_id;
        db.mdtGlFormulaLine.update(data, {'formula_line_id': formula_line_id})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var formula_line_id = req.body.formula_line_id;
        db.mdtGlFormulaLine.destroy({'formula_line_id':formula_line_id})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
