...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtClnPopularItemHeader.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        var POPULAR_HEADER_ID = req.body.POPULAR_HEADER_ID;
        db.mdtClnPopularItemHeader.find({where:{'POPULAR_HEADER_ID': POPULAR_HEADER_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtClnPopularItemHeader.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var POPULAR_HEADER_ID = req.body.POPULAR_HEADER_ID;
        db.mdtClnPopularItemHeader.update(data, {'POPULAR_HEADER_ID': POPULAR_HEADER_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var POPULAR_HEADER_ID = req.body.POPULAR_HEADER_ID;
        db.mdtClnPopularItemHeader.destroy({'POPULAR_HEADER_ID':POPULAR_HEADER_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
