...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtOmSoLine.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        var SO_LINE_ID = req.body.SO_LINE_ID;
        db.mdtOmSoLine.find({where:{'SO_LINE_ID': SO_LINE_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtOmSoLine.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var SO_LINE_ID = req.body.SO_LINE_ID;
        db.mdtOmSoLine.update(data, {'SO_LINE_ID': SO_LINE_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var SO_LINE_ID = req.body.SO_LINE_ID;
        db.mdtOmSoLine.destroy({'SO_LINE_ID':SO_LINE_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
