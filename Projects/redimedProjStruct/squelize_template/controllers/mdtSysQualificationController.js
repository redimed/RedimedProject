...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtSysQualification.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        var Qualifications_id = req.body.Qualifications_id;
        db.mdtSysQualification.find({where:{'Qualifications_id': Qualifications_id}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtSysQualification.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var Qualifications_id = req.body.Qualifications_id;
        db.mdtSysQualification.update(data, {'Qualifications_id': Qualifications_id})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var Qualifications_id = req.body.Qualifications_id;
        db.mdtSysQualification.destroy({'Qualifications_id':Qualifications_id})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
