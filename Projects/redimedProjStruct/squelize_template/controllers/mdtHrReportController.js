...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtHrReport.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        var id = req.body.id;
        db.mdtHrReport.find({where:{'id': id}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtHrReport.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var id = req.body.id;
        db.mdtHrReport.update(data, {'id': id})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
