...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtThFirstAssessment.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        var Ass_id = req.body.Ass_id;
        db.mdtThFirstAssessment.find({where:{'Ass_id': Ass_id}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtThFirstAssessment.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var Ass_id = req.body.Ass_id;
        db.mdtThFirstAssessment.update(data, {'Ass_id': Ass_id})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var Ass_id = req.body.Ass_id;
        db.mdtThFirstAssessment.destroy({'Ass_id':Ass_id})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
