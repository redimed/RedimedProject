...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtCustomer.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtCustomer.find({where:{'customer_id': customer_id}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtCustomer.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var customer_id = req.body.customer_id;
        db.mdtCustomer.update(data, {'customer_id': customer_id})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var customer_id = req.body.customer_id;
        db.mdtCustomer.destroy({'customer_id':customer_id})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
