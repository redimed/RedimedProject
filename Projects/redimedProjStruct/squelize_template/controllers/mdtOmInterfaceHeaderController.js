...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtOmInterfaceHeader.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtOmInterfaceHeader.find({where:{'HEADER_ID': HEADER_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtOmInterfaceHeader.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var HEADER_ID = req.body.HEADER_ID;
        db.mdtOmInterfaceHeader.update(data, {'HEADER_ID': HEADER_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var HEADER_ID = req.body.HEADER_ID;
        db.mdtOmInterfaceHeader.destroy({'HEADER_ID':HEADER_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
