...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtHrVisaPassport.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        var VisaPassPort_ID = req.body.VisaPassPort_ID;
        db.mdtHrVisaPassport.find({where:{'VisaPassPort_ID': VisaPassPort_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtHrVisaPassport.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var VisaPassPort_ID = req.body.VisaPassPort_ID;
        db.mdtHrVisaPassport.update(data, {'VisaPassPort_ID': VisaPassPort_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var VisaPassPort_ID = req.body.VisaPassPort_ID;
        db.mdtHrVisaPassport.destroy({'VisaPassPort_ID':VisaPassPort_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
