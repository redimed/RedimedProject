...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtClnItemFee.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        var ITEM_FEE_ID = req.body.ITEM_FEE_ID;
        db.mdtClnItemFee.find({where:{'ITEM_FEE_ID': ITEM_FEE_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtClnItemFee.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var ITEM_FEE_ID = req.body.ITEM_FEE_ID;
        db.mdtClnItemFee.update(data, {'ITEM_FEE_ID': ITEM_FEE_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var ITEM_FEE_ID = req.body.ITEM_FEE_ID;
        db.mdtClnItemFee.destroy({'ITEM_FEE_ID':ITEM_FEE_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
