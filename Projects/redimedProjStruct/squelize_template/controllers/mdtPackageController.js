...
module.exports = {
    ...
    postFindById: function(req, res){
        var id = req.body.id;
        db.mdtPackage.find({where:{'id': id}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtPackage.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var id = req.body.id;
        db.mdtPackage.update(data, {'id': id})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
