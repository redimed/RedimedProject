...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtInvTransactionType.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtInvTransactionType.find({where:{'TRANSACTION_TYPE_ID': TRANSACTION_TYPE_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtInvTransactionType.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var TRANSACTION_TYPE_ID = req.body.TRANSACTION_TYPE_ID;
        db.mdtInvTransactionType.update(data, {'TRANSACTION_TYPE_ID': TRANSACTION_TYPE_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var TRANSACTION_TYPE_ID = req.body.TRANSACTION_TYPE_ID;
        db.mdtInvTransactionType.destroy({'TRANSACTION_TYPE_ID':TRANSACTION_TYPE_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
