...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtGorgonCategory3.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtGorgonCategory3.find({where:{'cat_id': cat_id}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtGorgonCategory3.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var cat_id = req.body.cat_id;
        db.mdtGorgonCategory3.update(data, {'cat_id': cat_id})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var cat_id = req.body.cat_id;
        db.mdtGorgonCategory3.destroy({'cat_id':cat_id})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
