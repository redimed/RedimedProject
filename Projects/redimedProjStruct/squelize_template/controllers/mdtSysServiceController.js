...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtSysService.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtSysService.find({where:{'SERVICE_ID': SERVICE_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtSysService.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var SERVICE_ID = req.body.SERVICE_ID;
        db.mdtSysService.update(data, {'SERVICE_ID': SERVICE_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var SERVICE_ID = req.body.SERVICE_ID;
        db.mdtSysService.destroy({'SERVICE_ID':SERVICE_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
