...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtHrExperience.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtHrExperience.find({where:{'exp_id': exp_id}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtHrExperience.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var exp_id = req.body.exp_id;
        db.mdtHrExperience.update(data, {'exp_id': exp_id})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var exp_id = req.body.exp_id;
        db.mdtHrExperience.destroy({'exp_id':exp_id})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
