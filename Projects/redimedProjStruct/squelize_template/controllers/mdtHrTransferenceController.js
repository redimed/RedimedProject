...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtHrTransference.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtHrTransference.find({where:{'transfer_id': transfer_id}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtHrTransference.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var transfer_id = req.body.transfer_id;
        db.mdtHrTransference.update(data, {'transfer_id': transfer_id})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var transfer_id = req.body.transfer_id;
        db.mdtHrTransference.destroy({'transfer_id':transfer_id})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
