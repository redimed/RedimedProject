...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtPmPropertyPicture.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtPmPropertyPicture.find({where:{'pic_id': pic_id}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtPmPropertyPicture.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var pic_id = req.body.pic_id;
        db.mdtPmPropertyPicture.update(data, {'pic_id': pic_id})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var pic_id = req.body.pic_id;
        db.mdtPmPropertyPicture.destroy({'pic_id':pic_id})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
