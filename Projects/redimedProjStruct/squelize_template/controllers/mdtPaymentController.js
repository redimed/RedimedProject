...
module.exports = {
    ...
    postFindById: function(req, res){
        ...
        db.mdtPayment.find({where:{'payment_id': payment_id}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtPayment.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var payment_id = req.body.payment_id;
        db.mdtPayment.update(data, {'payment_id': payment_id})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var payment_id = req.body.payment_id;
        db.mdtPayment.destroy({'payment_id':payment_id})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
