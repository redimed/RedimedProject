...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtDocumenttype.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtDocumenttype.find({where:{'TypeValue': TypeValue}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtDocumenttype.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var TypeValue = req.body.TypeValue;
        db.mdtDocumenttype.update(data, {'TypeValue': TypeValue})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var TypeValue = req.body.TypeValue;
        db.mdtDocumenttype.destroy({'TypeValue':TypeValue})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
