...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtSysLookupLine.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtSysLookupLine.find({where:{'LINE_ID': LINE_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtSysLookupLine.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var LINE_ID = req.body.LINE_ID;
        db.mdtSysLookupLine.update(data, {'LINE_ID': LINE_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var LINE_ID = req.body.LINE_ID;
        db.mdtSysLookupLine.destroy({'LINE_ID':LINE_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
