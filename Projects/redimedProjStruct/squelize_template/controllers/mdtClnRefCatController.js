...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtClnRefCat.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtClnRefCat.find({where:{'CAT_id': CAT_id}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtClnRefCat.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var CAT_id = req.body.CAT_id;
        db.mdtClnRefCat.update(data, {'CAT_id': CAT_id})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var CAT_id = req.body.CAT_id;
        db.mdtClnRefCat.destroy({'CAT_id':CAT_id})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
