...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtSysPermernantCalendarDf.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtSysPermernantCalendarDf.find({where:{'cal_header_df_id': cal_header_df_id}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtSysPermernantCalendarDf.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var cal_header_df_id = req.body.cal_header_df_id;
        db.mdtSysPermernantCalendarDf.update(data, {'cal_header_df_id': cal_header_df_id})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var cal_header_df_id = req.body.cal_header_df_id;
        db.mdtSysPermernantCalendarDf.destroy({'cal_header_df_id':cal_header_df_id})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
