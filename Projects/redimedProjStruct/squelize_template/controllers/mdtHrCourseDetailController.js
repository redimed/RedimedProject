...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtHrCourseDetail.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        var course_detail_id = req.body.course_detail_id;
        db.mdtHrCourseDetail.find({where:{'course_detail_id': course_detail_id}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtHrCourseDetail.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var course_detail_id = req.body.course_detail_id;
        db.mdtHrCourseDetail.update(data, {'course_detail_id': course_detail_id})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var course_detail_id = req.body.course_detail_id;
        db.mdtHrCourseDetail.destroy({'course_detail_id':course_detail_id})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
