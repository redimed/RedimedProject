...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtApInvoiceLineAccount.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        var INVOICE_LINE_ACC_ID = req.body.INVOICE_LINE_ACC_ID;
        db.mdtApInvoiceLineAccount.find({where:{'INVOICE_LINE_ACC_ID': INVOICE_LINE_ACC_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtApInvoiceLineAccount.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var INVOICE_LINE_ACC_ID = req.body.INVOICE_LINE_ACC_ID;
        db.mdtApInvoiceLineAccount.update(data, {'INVOICE_LINE_ACC_ID': INVOICE_LINE_ACC_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var INVOICE_LINE_ACC_ID = req.body.INVOICE_LINE_ACC_ID;
        db.mdtApInvoiceLineAccount.destroy({'INVOICE_LINE_ACC_ID':INVOICE_LINE_ACC_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
