...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtHrElement.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        var id = req.body.id;
        db.mdtHrElement.find({where:{'id': id}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtHrElement.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var id = req.body.id;
        db.mdtHrElement.update(data, {'id': id})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
