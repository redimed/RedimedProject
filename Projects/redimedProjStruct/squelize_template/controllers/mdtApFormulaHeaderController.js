...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtApFormulaHeader.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtApFormulaHeader.find({where:{'FORMULA_ID': FORMULA_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtApFormulaHeader.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var FORMULA_ID = req.body.FORMULA_ID;
        db.mdtApFormulaHeader.update(data, {'FORMULA_ID': FORMULA_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var FORMULA_ID = req.body.FORMULA_ID;
        db.mdtApFormulaHeader.destroy({'FORMULA_ID':FORMULA_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
