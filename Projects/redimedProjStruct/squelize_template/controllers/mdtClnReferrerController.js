...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtClnReferrer.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtClnReferrer.find({where:{'REF_id': REF_id}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtClnReferrer.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var REF_id = req.body.REF_id;
        db.mdtClnReferrer.update(data, {'REF_id': REF_id})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var REF_id = req.body.REF_id;
        db.mdtClnReferrer.destroy({'REF_id':REF_id})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
