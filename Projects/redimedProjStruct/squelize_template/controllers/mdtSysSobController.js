...
module.exports = {
    ...
    postFindById: function(req, res){
        var SOB_ID = req.body.SOB_ID;
        db.mdtSysSob.find({where:{'SOB_ID': SOB_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtSysSob.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var SOB_ID = req.body.SOB_ID;
        db.mdtSysSob.update(data, {'SOB_ID': SOB_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var SOB_ID = req.body.SOB_ID;
        db.mdtSysSob.destroy({'SOB_ID':SOB_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
