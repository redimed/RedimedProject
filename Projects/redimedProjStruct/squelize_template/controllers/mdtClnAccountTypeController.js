...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtClnAccountType.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtClnAccountType.find({where:{'Account_id': Account_id}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtClnAccountType.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var Account_id = req.body.Account_id;
        db.mdtClnAccountType.update(data, {'Account_id': Account_id})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var Account_id = req.body.Account_id;
        db.mdtClnAccountType.destroy({'Account_id':Account_id})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
