...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtSysRcmGroupDescription.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        var RCM_GROUP_DES_ID = req.body.RCM_GROUP_DES_ID;
        db.mdtSysRcmGroupDescription.find({where:{'RCM_GROUP_DES_ID': RCM_GROUP_DES_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtSysRcmGroupDescription.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var RCM_GROUP_DES_ID = req.body.RCM_GROUP_DES_ID;
        db.mdtSysRcmGroupDescription.update(data, {'RCM_GROUP_DES_ID': RCM_GROUP_DES_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var RCM_GROUP_DES_ID = req.body.RCM_GROUP_DES_ID;
        db.mdtSysRcmGroupDescription.destroy({'RCM_GROUP_DES_ID':RCM_GROUP_DES_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
