...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtClnPopularItemLine.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        var POPULAR_LINE_ID = req.body.POPULAR_LINE_ID;
        db.mdtClnPopularItemLine.find({where:{'POPULAR_LINE_ID': POPULAR_LINE_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtClnPopularItemLine.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var POPULAR_LINE_ID = req.body.POPULAR_LINE_ID;
        db.mdtClnPopularItemLine.update(data, {'POPULAR_LINE_ID': POPULAR_LINE_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var POPULAR_LINE_ID = req.body.POPULAR_LINE_ID;
        db.mdtClnPopularItemLine.destroy({'POPULAR_LINE_ID':POPULAR_LINE_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
