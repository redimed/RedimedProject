...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtRediFunction.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtRediFunction.find({where:{'function_id': function_id}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtRediFunction.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var function_id = req.body.function_id;
        db.mdtRediFunction.update(data, {'function_id': function_id})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var function_id = req.body.function_id;
        db.mdtRediFunction.destroy({'function_id':function_id})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
