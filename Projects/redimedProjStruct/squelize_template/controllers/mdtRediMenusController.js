...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtRediMenus.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtRediMenus.find({where:{'menu_id': menu_id}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtRediMenus.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var menu_id = req.body.menu_id;
        db.mdtRediMenus.update(data, {'menu_id': menu_id})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var menu_id = req.body.menu_id;
        db.mdtRediMenus.destroy({'menu_id':menu_id})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
