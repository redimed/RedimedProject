...
module.exports = {
    ...
    postFindById: function(req, res){
        var cost_id = req.body.cost_id;
        db.mdtPmCost.find({where:{'cost_id': cost_id}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtPmCost.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var cost_id = req.body.cost_id;
        db.mdtPmCost.update(data, {'cost_id': cost_id})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var cost_id = req.body.cost_id;
        db.mdtPmCost.destroy({'cost_id':cost_id})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
