...
module.exports = {
    ...
    postFindById: function(req, res){
        ...
        db.mdtApBank.find({where:{'BANK_ID': BANK_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtApBank.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var BANK_ID = req.body.BANK_ID;
        db.mdtApBank.update(data, {'BANK_ID': BANK_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var BANK_ID = req.body.BANK_ID;
        db.mdtApBank.destroy({'BANK_ID':BANK_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
