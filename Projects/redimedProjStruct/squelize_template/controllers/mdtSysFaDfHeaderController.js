...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtSysFaDfHeader.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtSysFaDfHeader.find({where:{'FA_ID': FA_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtSysFaDfHeader.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var FA_ID = req.body.FA_ID;
        db.mdtSysFaDfHeader.update(data, {'FA_ID': FA_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var FA_ID = req.body.FA_ID;
        db.mdtSysFaDfHeader.destroy({'FA_ID':FA_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
