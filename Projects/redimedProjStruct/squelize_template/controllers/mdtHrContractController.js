...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtHrContract.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtHrContract.find({where:{'contract_id': contract_id}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtHrContract.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var contract_id = req.body.contract_id;
        db.mdtHrContract.update(data, {'contract_id': contract_id})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var contract_id = req.body.contract_id;
        db.mdtHrContract.destroy({'contract_id':contract_id})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
