...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtOmClinicSite.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        var OM_SITE_ID = req.body.OM_SITE_ID;
        db.mdtOmClinicSite.find({where:{'OM_SITE_ID': OM_SITE_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtOmClinicSite.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var OM_SITE_ID = req.body.OM_SITE_ID;
        db.mdtOmClinicSite.update(data, {'OM_SITE_ID': OM_SITE_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var OM_SITE_ID = req.body.OM_SITE_ID;
        db.mdtOmClinicSite.destroy({'OM_SITE_ID':OM_SITE_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
