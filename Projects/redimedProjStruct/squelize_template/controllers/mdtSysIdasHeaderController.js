...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtSysIdasHeader.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        var IDAS_DF_ID = req.body.IDAS_DF_ID;
        db.mdtSysIdasHeader.find({where:{'IDAS_DF_ID': IDAS_DF_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtSysIdasHeader.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var IDAS_DF_ID = req.body.IDAS_DF_ID;
        db.mdtSysIdasHeader.update(data, {'IDAS_DF_ID': IDAS_DF_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var IDAS_DF_ID = req.body.IDAS_DF_ID;
        db.mdtSysIdasHeader.destroy({'IDAS_DF_ID':IDAS_DF_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
