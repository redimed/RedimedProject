...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtSysEntitySite.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtSysEntitySite.find({where:{'SITE_ID': SITE_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtSysEntitySite.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var SITE_ID = req.body.SITE_ID;
        db.mdtSysEntitySite.update(data, {'SITE_ID': SITE_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var SITE_ID = req.body.SITE_ID;
        db.mdtSysEntitySite.destroy({'SITE_ID':SITE_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
