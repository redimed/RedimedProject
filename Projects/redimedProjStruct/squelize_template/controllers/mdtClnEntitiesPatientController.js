...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtClnEntitiesPatient.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        var id = req.body.id;
        db.mdtClnEntitiesPatient.find({where:{'id': id}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtClnEntitiesPatient.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var id = req.body.id;
        db.mdtClnEntitiesPatient.update(data, {'id': id})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var id = req.body.id;
        db.mdtClnEntitiesPatient.destroy({'id':id})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
