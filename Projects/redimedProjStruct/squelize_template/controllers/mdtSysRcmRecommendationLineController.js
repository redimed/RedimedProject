...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtSysRcmRecommendationLine.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        var RCM_RC_LINE_ID = req.body.RCM_RC_LINE_ID;
        db.mdtSysRcmRecommendationLine.find({where:{'RCM_RC_LINE_ID': RCM_RC_LINE_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtSysRcmRecommendationLine.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var RCM_RC_LINE_ID = req.body.RCM_RC_LINE_ID;
        db.mdtSysRcmRecommendationLine.update(data, {'RCM_RC_LINE_ID': RCM_RC_LINE_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var RCM_RC_LINE_ID = req.body.RCM_RC_LINE_ID;
        db.mdtSysRcmRecommendationLine.destroy({'RCM_RC_LINE_ID':RCM_RC_LINE_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
