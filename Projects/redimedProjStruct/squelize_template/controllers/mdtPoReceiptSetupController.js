...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtPoReceiptSetup.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        var RECEIPT_SETUP_ID = req.body.RECEIPT_SETUP_ID;
        db.mdtPoReceiptSetup.find({where:{'RECEIPT_SETUP_ID': RECEIPT_SETUP_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtPoReceiptSetup.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var RECEIPT_SETUP_ID = req.body.RECEIPT_SETUP_ID;
        db.mdtPoReceiptSetup.update(data, {'RECEIPT_SETUP_ID': RECEIPT_SETUP_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var RECEIPT_SETUP_ID = req.body.RECEIPT_SETUP_ID;
        db.mdtPoReceiptSetup.destroy({'RECEIPT_SETUP_ID':RECEIPT_SETUP_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
