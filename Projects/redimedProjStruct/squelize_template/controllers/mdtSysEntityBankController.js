...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtSysEntityBank.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtSysEntityBank.find({where:{'BANK_ID': BANK_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtSysEntityBank.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var BANK_ID = req.body.BANK_ID;
        db.mdtSysEntityBank.update(data, {'BANK_ID': BANK_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var BANK_ID = req.body.BANK_ID;
        db.mdtSysEntityBank.destroy({'BANK_ID':BANK_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
