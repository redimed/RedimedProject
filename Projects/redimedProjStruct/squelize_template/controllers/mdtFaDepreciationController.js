...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtFaDepreciation.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        var AssetDepreciationID = req.body.AssetDepreciationID;
        db.mdtFaDepreciation.find({where:{'AssetDepreciationID': AssetDepreciationID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtFaDepreciation.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var AssetDepreciationID = req.body.AssetDepreciationID;
        db.mdtFaDepreciation.update(data, {'AssetDepreciationID': AssetDepreciationID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var AssetDepreciationID = req.body.AssetDepreciationID;
        db.mdtFaDepreciation.destroy({'AssetDepreciationID':AssetDepreciationID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
