...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtThStoreImageHeader.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        var HEADER_CODE = req.body.HEADER_CODE;
        db.mdtThStoreImageHeader.find({where:{'HEADER_CODE': HEADER_CODE}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtThStoreImageHeader.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var HEADER_CODE = req.body.HEADER_CODE;
        db.mdtThStoreImageHeader.update(data, {'HEADER_CODE': HEADER_CODE})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var HEADER_CODE = req.body.HEADER_CODE;
        db.mdtThStoreImageHeader.destroy({'HEADER_CODE':HEADER_CODE})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
