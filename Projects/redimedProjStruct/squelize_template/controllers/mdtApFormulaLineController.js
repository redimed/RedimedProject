...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtApFormulaLine.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        var FORMULA_LINE_ID = req.body.FORMULA_LINE_ID;
        db.mdtApFormulaLine.find({where:{'FORMULA_LINE_ID': FORMULA_LINE_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtApFormulaLine.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var FORMULA_LINE_ID = req.body.FORMULA_LINE_ID;
        db.mdtApFormulaLine.update(data, {'FORMULA_LINE_ID': FORMULA_LINE_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var FORMULA_LINE_ID = req.body.FORMULA_LINE_ID;
        db.mdtApFormulaLine.destroy({'FORMULA_LINE_ID':FORMULA_LINE_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
