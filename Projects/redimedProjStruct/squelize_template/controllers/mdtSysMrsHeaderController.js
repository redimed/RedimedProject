...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtSysMrsHeader.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        var MRS_DF_ID = req.body.MRS_DF_ID;
        db.mdtSysMrsHeader.find({where:{'MRS_DF_ID': MRS_DF_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtSysMrsHeader.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var MRS_DF_ID = req.body.MRS_DF_ID;
        db.mdtSysMrsHeader.update(data, {'MRS_DF_ID': MRS_DF_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var MRS_DF_ID = req.body.MRS_DF_ID;
        db.mdtSysMrsHeader.destroy({'MRS_DF_ID':MRS_DF_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
