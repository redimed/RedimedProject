...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtHrBudgetTrainingEmployee.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtHrBudgetTrainingEmployee.find({where:{'budget_id': budget_id}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtHrBudgetTrainingEmployee.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var budget_id = req.body.budget_id;
        db.mdtHrBudgetTrainingEmployee.update(data, {'budget_id': budget_id})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var budget_id = req.body.budget_id;
        db.mdtHrBudgetTrainingEmployee.destroy({'budget_id':budget_id})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
