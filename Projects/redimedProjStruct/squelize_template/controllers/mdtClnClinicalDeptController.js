...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtClnClinicalDept.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtClnClinicalDept.find({where:{'CLINICAL_DEPT_ID': CLINICAL_DEPT_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtClnClinicalDept.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var CLINICAL_DEPT_ID = req.body.CLINICAL_DEPT_ID;
        db.mdtClnClinicalDept.update(data, {'CLINICAL_DEPT_ID': CLINICAL_DEPT_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var CLINICAL_DEPT_ID = req.body.CLINICAL_DEPT_ID;
        db.mdtClnClinicalDept.destroy({'CLINICAL_DEPT_ID':CLINICAL_DEPT_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
