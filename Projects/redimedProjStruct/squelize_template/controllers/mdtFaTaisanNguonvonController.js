...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtFaTaisanNguonvon.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtFaTaisanNguonvon.find({where:{'LineID': LineID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtFaTaisanNguonvon.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var LineID = req.body.LineID;
        db.mdtFaTaisanNguonvon.update(data, {'LineID': LineID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var LineID = req.body.LineID;
        db.mdtFaTaisanNguonvon.destroy({'LineID':LineID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
