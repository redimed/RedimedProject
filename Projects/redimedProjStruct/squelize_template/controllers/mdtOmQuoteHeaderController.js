...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtOmQuoteHeader.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        var QUOTE_HEADER_ID = req.body.QUOTE_HEADER_ID;
        db.mdtOmQuoteHeader.find({where:{'QUOTE_HEADER_ID': QUOTE_HEADER_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtOmQuoteHeader.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var QUOTE_HEADER_ID = req.body.QUOTE_HEADER_ID;
        db.mdtOmQuoteHeader.update(data, {'QUOTE_HEADER_ID': QUOTE_HEADER_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var QUOTE_HEADER_ID = req.body.QUOTE_HEADER_ID;
        db.mdtOmQuoteHeader.destroy({'QUOTE_HEADER_ID':QUOTE_HEADER_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
