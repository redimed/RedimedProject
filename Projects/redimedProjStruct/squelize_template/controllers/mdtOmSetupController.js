...
module.exports = {
    ...
    postFindById: function(req, res){
        var OM_SETUP_ID = req.body.OM_SETUP_ID;
        db.mdtOmSetup.find({where:{'OM_SETUP_ID': OM_SETUP_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtOmSetup.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var OM_SETUP_ID = req.body.OM_SETUP_ID;
        db.mdtOmSetup.update(data, {'OM_SETUP_ID': OM_SETUP_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var OM_SETUP_ID = req.body.OM_SETUP_ID;
        db.mdtOmSetup.destroy({'OM_SETUP_ID':OM_SETUP_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
