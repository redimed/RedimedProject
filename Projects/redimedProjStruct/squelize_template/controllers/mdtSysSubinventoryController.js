...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtSysSubinventory.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtSysSubinventory.find({where:{'SUB_ID': SUB_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtSysSubinventory.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var SUB_ID = req.body.SUB_ID;
        db.mdtSysSubinventory.update(data, {'SUB_ID': SUB_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var SUB_ID = req.body.SUB_ID;
        db.mdtSysSubinventory.destroy({'SUB_ID':SUB_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
