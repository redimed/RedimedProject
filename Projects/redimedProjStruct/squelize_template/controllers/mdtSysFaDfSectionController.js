...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtSysFaDfSection.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtSysFaDfSection.find({where:{'SECTION_ID': SECTION_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtSysFaDfSection.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var SECTION_ID = req.body.SECTION_ID;
        db.mdtSysFaDfSection.update(data, {'SECTION_ID': SECTION_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var SECTION_ID = req.body.SECTION_ID;
        db.mdtSysFaDfSection.destroy({'SECTION_ID':SECTION_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
