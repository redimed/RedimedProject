...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtSysPaymentTerm.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        var PAYMENT_TERM_ID = req.body.PAYMENT_TERM_ID;
        db.mdtSysPaymentTerm.find({where:{'PAYMENT_TERM_ID': PAYMENT_TERM_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtSysPaymentTerm.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var PAYMENT_TERM_ID = req.body.PAYMENT_TERM_ID;
        db.mdtSysPaymentTerm.update(data, {'PAYMENT_TERM_ID': PAYMENT_TERM_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var PAYMENT_TERM_ID = req.body.PAYMENT_TERM_ID;
        db.mdtSysPaymentTerm.destroy({'PAYMENT_TERM_ID':PAYMENT_TERM_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
