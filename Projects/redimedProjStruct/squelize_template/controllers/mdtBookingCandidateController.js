...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtBookingCandidate.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtBookingCandidate.find({where:{'Candidate_id': Candidate_id}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtBookingCandidate.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var Candidate_id = req.body.Candidate_id;
        db.mdtBookingCandidate.update(data, {'Candidate_id': Candidate_id})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var Candidate_id = req.body.Candidate_id;
        db.mdtBookingCandidate.destroy({'Candidate_id':Candidate_id})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
