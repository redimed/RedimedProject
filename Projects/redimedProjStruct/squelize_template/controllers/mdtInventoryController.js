...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtInventory.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtInventory.find({where:{'inventory_id': inventory_id}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtInventory.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var inventory_id = req.body.inventory_id;
        db.mdtInventory.update(data, {'inventory_id': inventory_id})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var inventory_id = req.body.inventory_id;
        db.mdtInventory.destroy({'inventory_id':inventory_id})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
