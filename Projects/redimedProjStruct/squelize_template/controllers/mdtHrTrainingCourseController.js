...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtHrTrainingCourse.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtHrTrainingCourse.find({where:{'course_id': course_id}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtHrTrainingCourse.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var course_id = req.body.course_id;
        db.mdtHrTrainingCourse.update(data, {'course_id': course_id})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var course_id = req.body.course_id;
        db.mdtHrTrainingCourse.destroy({'course_id':course_id})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
