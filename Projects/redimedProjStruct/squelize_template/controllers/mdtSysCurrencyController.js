...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtSysCurrency.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        var CURR_CODE = req.body.CURR_CODE;
        db.mdtSysCurrency.find({where:{'CURR_CODE': CURR_CODE}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtSysCurrency.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var CURR_CODE = req.body.CURR_CODE;
        db.mdtSysCurrency.update(data, {'CURR_CODE': CURR_CODE})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var CURR_CODE = req.body.CURR_CODE;
        db.mdtSysCurrency.destroy({'CURR_CODE':CURR_CODE})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
