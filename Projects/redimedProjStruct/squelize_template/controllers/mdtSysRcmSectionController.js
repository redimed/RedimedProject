...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtSysRcmSection.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        var RCM_SECTION_ID = req.body.RCM_SECTION_ID;
        db.mdtSysRcmSection.find({where:{'RCM_SECTION_ID': RCM_SECTION_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtSysRcmSection.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var RCM_SECTION_ID = req.body.RCM_SECTION_ID;
        db.mdtSysRcmSection.update(data, {'RCM_SECTION_ID': RCM_SECTION_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var RCM_SECTION_ID = req.body.RCM_SECTION_ID;
        db.mdtSysRcmSection.destroy({'RCM_SECTION_ID':RCM_SECTION_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
