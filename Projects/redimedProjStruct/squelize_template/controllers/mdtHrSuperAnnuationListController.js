...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtHrSuperAnnuationList.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        var super_id = req.body.super_id;
        db.mdtHrSuperAnnuationList.find({where:{'super_id': super_id}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtHrSuperAnnuationList.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var super_id = req.body.super_id;
        db.mdtHrSuperAnnuationList.update(data, {'super_id': super_id})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var super_id = req.body.super_id;
        db.mdtHrSuperAnnuationList.destroy({'super_id':super_id})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
