...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtPmProces.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtPmProces.find({where:{'process_id': process_id}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtPmProces.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var process_id = req.body.process_id;
        db.mdtPmProces.update(data, {'process_id': process_id})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var process_id = req.body.process_id;
        db.mdtPmProces.destroy({'process_id':process_id})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
