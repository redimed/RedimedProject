...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtArInvoiceLineAccount.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        var LINE_ACC_ID = req.body.LINE_ACC_ID;
        db.mdtArInvoiceLineAccount.find({where:{'LINE_ACC_ID': LINE_ACC_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtArInvoiceLineAccount.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var LINE_ACC_ID = req.body.LINE_ACC_ID;
        db.mdtArInvoiceLineAccount.update(data, {'LINE_ACC_ID': LINE_ACC_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var LINE_ACC_ID = req.body.LINE_ACC_ID;
        db.mdtArInvoiceLineAccount.destroy({'LINE_ACC_ID':LINE_ACC_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
