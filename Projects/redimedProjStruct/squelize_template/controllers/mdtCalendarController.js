...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtCalendar.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtCalendar.find({where:{'cal_id': cal_id}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtCalendar.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var cal_id = req.body.cal_id;
        db.mdtCalendar.update(data, {'cal_id': cal_id})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var cal_id = req.body.cal_id;
        db.mdtCalendar.destroy({'cal_id':cal_id})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
