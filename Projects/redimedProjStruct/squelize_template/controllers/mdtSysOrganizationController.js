...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtSysOrganization.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtSysOrganization.find({where:{'ORG_ID': ORG_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtSysOrganization.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var ORG_ID = req.body.ORG_ID;
        db.mdtSysOrganization.update(data, {'ORG_ID': ORG_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var ORG_ID = req.body.ORG_ID;
        db.mdtSysOrganization.destroy({'ORG_ID':ORG_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
