...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtApInvoice.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtApInvoice.find({where:{'INVOICE_ID': INVOICE_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtApInvoice.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var INVOICE_ID = req.body.INVOICE_ID;
        db.mdtApInvoice.update(data, {'INVOICE_ID': INVOICE_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var INVOICE_ID = req.body.INVOICE_ID;
        db.mdtApInvoice.destroy({'INVOICE_ID':INVOICE_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
