...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtSysMrsGroup.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        var MRS_GROUP_ID = req.body.MRS_GROUP_ID;
        db.mdtSysMrsGroup.find({where:{'MRS_GROUP_ID': MRS_GROUP_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtSysMrsGroup.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var MRS_GROUP_ID = req.body.MRS_GROUP_ID;
        db.mdtSysMrsGroup.update(data, {'MRS_GROUP_ID': MRS_GROUP_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var MRS_GROUP_ID = req.body.MRS_GROUP_ID;
        db.mdtSysMrsGroup.destroy({'MRS_GROUP_ID':MRS_GROUP_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
