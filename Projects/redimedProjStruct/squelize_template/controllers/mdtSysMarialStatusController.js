...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtSysMarialStatus.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        var Marial_status = req.body.Marial_status;
        db.mdtSysMarialStatus.find({where:{'Marial_status': Marial_status}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtSysMarialStatus.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var Marial_status = req.body.Marial_status;
        db.mdtSysMarialStatus.update(data, {'Marial_status': Marial_status})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var Marial_status = req.body.Marial_status;
        db.mdtSysMarialStatus.destroy({'Marial_status':Marial_status})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
