...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtSysCateDetail.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtSysCateDetail.find({where:{'CATE_ID': CATE_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtSysCateDetail.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var CATE_ID = req.body.CATE_ID;
        db.mdtSysCateDetail.update(data, {'CATE_ID': CATE_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var CATE_ID = req.body.CATE_ID;
        db.mdtSysCateDetail.destroy({'CATE_ID':CATE_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
