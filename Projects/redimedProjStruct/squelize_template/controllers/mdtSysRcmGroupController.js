...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtSysRcmGroup.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        var RCM_GROUP_ID = req.body.RCM_GROUP_ID;
        db.mdtSysRcmGroup.find({where:{'RCM_GROUP_ID': RCM_GROUP_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtSysRcmGroup.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var RCM_GROUP_ID = req.body.RCM_GROUP_ID;
        db.mdtSysRcmGroup.update(data, {'RCM_GROUP_ID': RCM_GROUP_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var RCM_GROUP_ID = req.body.RCM_GROUP_ID;
        db.mdtSysRcmGroup.destroy({'RCM_GROUP_ID':RCM_GROUP_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
