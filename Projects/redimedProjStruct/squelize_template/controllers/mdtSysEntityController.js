...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtSysEntity.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        ...
        db.mdtSysEntity.find({where:{'ENTITY_ID': ENTITY_ID}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtSysEntity.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var ENTITY_ID = req.body.ENTITY_ID;
        db.mdtSysEntity.update(data, {'ENTITY_ID': ENTITY_ID})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var ENTITY_ID = req.body.ENTITY_ID;
        db.mdtSysEntity.destroy({'ENTITY_ID':ENTITY_ID})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
