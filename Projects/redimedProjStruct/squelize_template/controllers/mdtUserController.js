...
module.exports = {
    ...
    postFindById: function(req, res){
        var id = req.body.id;
        db.mdtUser.find({where:{'id': id}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtUser.create(data).success(function(){
