...
module.exports = {
    postSearch: function(req, res){
        ...
        db.mdtClnSpecialty.findAndCountAll({
            where: [sql],
    ...
    postFindById: function(req, res){
        var Specialties_id = req.body.Specialties_id;
        db.mdtClnSpecialty.find({where:{'Specialties_id': Specialties_id}},{raw:true})
    ...
    postInsert: function(req,res){
        ...
        db.mdtClnSpecialty.create(data).success(function(){
    ...
    postUpdate: function(req, res){
        var data = req.body.data; // JSON object data
        var Specialties_id = req.body.Specialties_id;
        db.mdtClnSpecialty.update(data, {'Specialties_id': Specialties_id})
        .success(function(){
            res.json({status:"success"});
        })
        .error(function(err){
    ...
    postDelete: function(req,res){
        var Specialties_id = req.body.Specialties_id;
        db.mdtClnSpecialty.destroy({'Specialties_id':Specialties_id})
        .success(function(data){
            res.json({status:'success'})
        })
        .error(function(err){
