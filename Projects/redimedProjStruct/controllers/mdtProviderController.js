...
module.exports = {
	postAdd: function(req, res){
		...
		db.mdtProvider.create(postData)
	...
	postSearch: function(req, res){
		...
		db.mdtProvider.findAndCountAll({
			where: [sql],
