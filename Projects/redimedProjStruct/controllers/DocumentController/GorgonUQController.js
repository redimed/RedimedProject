...
module.exports = {
    printReport : function(req,res){
        ...
        //mkdirp('./download/report/GorgonUQ', function (err) {
        ...
        //
        //java.callStaticMethodSync('net.sf.jasperreports.engine.JasperExportManager','exportReportToPdfFile',jPrint,'./download/report/GorgonUQ/UserQuestionnaire.pdf');
        //
        //
        //res.download('./download/report/GorgonUQ/UserQuestionnaire.pdf');
