...
module.exports = {
    loadSA1: function (req, res) {
        ...
        db.headersSACLN.findAll({where: {PATIENT_ID: 999, CAL_ID: 999, SA_ID: 3}}, {raw: true})
            .success(function (dataH) {
                db.sectionsSACLN.findAll({where: {PATIENT_ID: 999, CAL_ID: 999, SA_ID: 3}}, {raw: true})
                    .success(function (dataS) {
                        db.linesSACLN.findAll({where: {PATIENT_ID: 999, CAL_ID: 999, SA_ID: 3}}, {raw: true})
