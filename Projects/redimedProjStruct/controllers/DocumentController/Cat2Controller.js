...
module.exports = {
    printReport : function(req,res){
        ...
        mkdirp('./download/report/CAT2', function (err) {
        ...
        paramMap.putSync("realPath","./reports/CAT2/");
        ...
        java.callStaticMethodSync('net.sf.jasperreports.engine.JasperExportManager','exportReportToPdfFile',jPrint,'./download/report/CAT2/cat2.pdf');

        res.download('./download/report/CAT2/cat2.pdf');
    },
