...
module.exports = {
    ...
    insertMA: function(req, res) {
        ...
        db.docMA.create({
                ...
                COMMENT_SEC4: info.COMMENT_SEC4,
                COMMENT_SEC5: info.COMMENT_SEC5,
                COMMENT_SEC6: info.COMMENT_SEC6,
                COMMENT_SEC7: info.COMMENT_SEC7,
                COMMENT_SEC8: info.COMMENT_SEC8,
