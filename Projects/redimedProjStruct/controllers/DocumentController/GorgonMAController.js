...
module.exports = {
    printReport : function(req,res){
        mkdirp('./download/report/GorgonMA', function (err) {
        ...
        java.callStaticMethodSync('net.sf.jasperreports.engine.JasperExportManager','exportReportToPdfFile',jPrint,'./download/report/GorgonMA/gorgonMA.pdf');


        res.download('./download/report/GorgonMA/gorgonMA.pdf');
