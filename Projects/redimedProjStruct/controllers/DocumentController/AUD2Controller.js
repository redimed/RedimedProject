...
//Begin--LoadAUD2--Audiogram 2//
    loadAUD2: function (req, res) {
        ...
        db.sequelize.query("SELECT SA_ID, SA_NAME FROM CLN_SA_DF_HEADERS WHERE PATIENT_ID = 1", null, {raw: true}).success(function (dataH) {
            db.sequelize.query("SELECT SA_ID, SECTION_ID, SECTION_NAME FROM CLN_SA_DF_SECTIONS WHERE SECTION_ID = 7 AND PATIENT_ID = 1", null, {raw: true}).success(function (dataS) {
