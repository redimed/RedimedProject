...
module.exports = {
	postAdd: function(req, res){
		...
		db.sysQualification.create(postData)
	...
	postEdit: function(req, res){
		...
		db.sysQualification.find(edit_id)
	...
	postDelete: function(req, res){
		...
		db.sysQualification.find(delete_id)
		.success(function(detail){
			if(!detail) res.json(500, {'status': 'error', 'message': 'Id Missing !!!'});
	...
	postById: function(req, res){
		...
		db.sysQualification.find(detail_id)
		.success(function(detail){
	...
	postSearch: function(req, res){
		...
		db.sysQualification.findAndCountAll({
			where: [sql],
