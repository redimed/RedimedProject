...
module.exports = {
    printReport: function (req, res, next) {
        ...
        mkdirp('.\\download\\report\\WA\\ProgressAssessment_' +id , function (err) {
            if (err) console.error("******************* ERROR:" + err + '*******************');
                ...
                paramMap.putSync("real_path", "./reports/ProgressWA/");

                var filePath = '.\\download\\report\\WA\\ProgressAssessment_' +id + '\\ProgressWA.pdf';

                var jPrint = java.callStaticMethodSync('net.sf.jasperreports.engine.JasperFillManager', 'fillReport', './reports/ProgressWA/ProgressWA.jasper', paramMap, con);
                ...
                java.callStaticMethod('net.sf.jasperreports.engine.JasperExportManager', 'exportReportToPdfFile', jPrint, filePath, function (err, rs) {
                    if (err) {
                        ...
                        res.download(filePath, 'ProgressWA.pdf', function (err) {
                            if (err) {
                                console.log("******************* ERROR:" + err + ' *******************');
                                return;
                            }
    ...
    postAdd: function (req, res) {
        ...
        db.WaWorkCoverProgress.create(postData)
    ...
    postEdit: function (req, res) {
        ...
        db.WaWorkCoverProgress.find(edit_id)
    ...
    postSearch: function (req, res) {
        ...
        db.WaWorkCoverProgress.findAndCountAll({
            where: [sql]
