...
$pdf->writeHTMLCell($w=200,$h=20,$x=45,$y=94,$address,$border=0,$ln=0,$fill=0,$reseth=true,$align='',$autopadding=true); //address
...
///doctor
$pdf->writeHTMLCell($w=80, $h=20, $x=52, $y=119.5, $pdata['info_drname'], $border=0, $ln=1, $fill=0, $reseth=true, $align='', $autopadding=true); //first name
$pdf->writeHTMLCell($w=200, $h=20, $x=52, $y=128, $pdata['info_draddress'], $border=0, $ln=1, $fill=0, $reseth=true, $align='', $autopadding=true); // last name
$pdf->writeHTMLCell($w=80, $h=20, $x=145, $y=119.5, $pdata['info_drphone'], $border=0, $ln=1, $fill=0, $reseth=true, $align='', $autopadding=true); // address
...
if(array_key_exists("signtxt",$pdata)){
    ...
    copy("data:image/png;base64,".$imgdata,"output/temp4.png");

    list($width, $height, $type, $attr)= getimagesize("output/temp4.png");
    $pdf->Image("output/temp4.png", 54, 166, 46, 13, '', '', '', false, 300, '', false, false, 0);
}else{
...
//what's happen
$pdf->writeHTMLCell($w=200, $h=20, $x=54, $y=199.5, "hungcaothanh", $border=0, $ln=1, $fill=0, $reseth=true, $align='', $autopadding=true); // address
//worker's sympton
$pdf->writeHTMLCell($w=200, $h=20, $x=54, $y=207, "hungcaothanh", $border=0, $ln=1, $fill=0, $reseth=true, $align='', $autopadding=true); // address
...
$pdf->writeHTMLCell($w=200, $h=40, $x=61, $y=243, $clinicalFindings, $border=0, $ln=1, $fill=0, $reseth=true, $align='', $autopadding=true); // address
//Dianologic
...
$pdf->writeHTMLCell($w=200, $h=20, $x=61, $y=255.5, $dianologic, $border=0, $ln=1, $fill=0, $reseth=true, $align='', $autopadding=true); // address
...
$pdf->writeHTMLCell($w=200, $h=20, $x=57, $y=19, $workderusualsuties, $border=0, $ln=1, $fill=0, $reseth=true, $align='', $autopadding=true); // address
...
$pdf->writeHTMLCell($w=60, $h=20, $x=19, $y=140, $activities1, $border=0, $ln=1, $fill=0, $reseth=true, $align='', $autopadding=true); // address
...
$pdf->writeHTMLCell($w=60, $h=20, $x=19, $y=145.5, $activities2, $border=0, $ln=1, $fill=0, $reseth=true, $align='', $autopadding=true); // address
...
$pdf->writeHTMLCell($w=60, $h=20, $x=19, $y=151, $activities3, $border=0, $ln=1, $fill=0, $reseth=true, $align='', $autopadding=true); // address
...
$pdf->writeHTMLCell($w=60, $h=20, $x=19, $y=157, $activities4, $border=0, $ln=1, $fill=0, $reseth=true, $align='', $autopadding=true); // address
...
$pdf->writeHTMLCell($w=60, $h=20, $x=19, $y=162.5, $activities5, $border=0, $ln=1, $fill=0, $reseth=true, $align='', $autopadding=true); // address
...
$pdf->writeHTMLCell($w=60, $h=20, $x=19, $y=168.5, $activities6, $border=0, $ln=1, $fill=0, $reseth=true, $align='', $autopadding=true); // address
...
$pdf->writeHTMLCell($w=120, $h=20, $x=69, $y=140, $purpose1, $border=0, $ln=1, $fill=0, $reseth=true, $align='', $autopadding=true); // address
...
$pdf->writeHTMLCell($w=120, $h=20, $x=69, $y=145.5, $purpose2, $border=0, $ln=1, $fill=0, $reseth=true, $align='', $autopadding=true); // address
...
$pdf->writeHTMLCell($w=120, $h=20, $x=69, $y=151, $purpose3, $border=0, $ln=1, $fill=0, $reseth=true, $align='', $autopadding=true); // address
...
$pdf->writeHTMLCell($w=120, $h=20, $x=69, $y=157, $purpose4, $border=0, $ln=1, $fill=0, $reseth=true, $align='', $autopadding=true); // address
...
$pdf->writeHTMLCell($w=120, $h=20, $x=69, $y=162.5, $purpose5, $border=0, $ln=1, $fill=0, $reseth=true, $align='', $autopadding=true); // address
...
$pdf->writeHTMLCell($w=120, $h=20, $x=69, $y=168.5, $purpose6, $border=0, $ln=1, $fill=0, $reseth=true, $align='', $autopadding=true); // address
...
$pdf->writeHTMLCell($w=200, $h=20, $x=39, $y=228.5, $comment, $border=0, $ln=1, $fill=0, $reseth=true, $align='', $autopadding=true); // address
...
if(strlen($drsign) > 0){
	...
	$pdf->Image("output/temp5.png", 127, 260,63, 11.5, '', '', '', false, 300, '', false, false, 0); // no capacity for any work
