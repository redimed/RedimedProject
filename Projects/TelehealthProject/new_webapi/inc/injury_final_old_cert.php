...
$pdf->writeHTMLCell($w=80,$h=20,$x=45,$y=80.5,$address,$border=0,$ln=0,$fill=0,$reseth=true,$align='',$autopadding=true); //address
...
$pdf->writeHTMLCell($w=80, $h=20, $x=145, $y=96.5, "hungcaothanh", $border=0, $ln=1, $fill=0, $reseth=true, $align='', $autopadding=true); // address
...
$pdf->writeHTMLCell($w=80, $h=20, $x=81, $y=177, $dataComment, $border=0, $ln=1, $fill=0, $reseth=true, $align='', $autopadding=true); // address
...
$pdf->writeHTMLCell($w=80, $h=20, $x=23, $y=224.5, $dataoulineyourclinical, $border=0, $ln=1, $fill=0, $reseth=true, $align='', $autopadding=true); // address
...
//Signature
$drsign = "images/signup.jpg";
$pdf->Image($drsign, 125, 259,64, 13, '', '', '', false, 300, '', false, false, 0); // no capacity for any work
