<div data-role="page" id="list">
	<script type="text/javascript">
		$("#list").bind( "pageinit", function(){
			...
			$('a[name|="delete"]').click(function() {							
				...
				$.ajax({
				  type: "POST",
				  url: "/telehealth/index.php/redimed/deleteUser/"+$(this).attr('id'),
				}).done(function( msg ) {
				  //				  	
	...
	<div data-role="content">	
		<a href="/telehealth/index.php/redimed/addUser" data-role="button" id="addComp" data-icon="plus" data-inline="true">Add doctor</a>
		<p>
            	...
            	<?php foreach($data as $key => $entry) : ?>	
                            ...
                            <div data-role="actionsheet" class="ui-actionsheet-content ui-corner-top ui-corner-bottom" id="functions" data-theme="b">
                                <div data-role="content" data-theme="b" class="ui-corner-top ui-corner-bottom ui-content ui-body-b">
                                    <h3>Please choose a function for <?= $entry['username'];?>.</h3>                            
                                    <!--<a href="detail/<?= $entry['id'];?>" data-role="button" data-icon="search">View</a>-->	
                                    <a href="editUser/<?= $entry['id'];?>" data-role="button" data-icon="info" >Edit</a>
                                    <a href="#" data-role="button" data-sheet='change' name="list-cpwd<?= $entry['id'];?>" id="<?= $entry['id'];?>"> Change password</a>
                            ...
                            <div data-role="actionsheet" class="ui-actionsheet-content ui-corner-top ui-corner-bottom" id="change" data-theme="b">
                                <div data-role="content" id="formdiv-<?= $entry['id'];?>" data-theme="b" class="ui-corner-top ui-corner-bottom ui-content ui-body-b">
                                    <h3>Please choose a function.</h3>
                                    <form action="index.php/submit" method="post" id="cpwd-form-<?= $entry['id'];?>" name="cpwd-form-<?= $entry['id'];?>" autocomplete="off">	
                                    <table>
                                        <tr>
                                            <td >
                                                <table width="100%">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div data-mini="true" data-role="fieldcontain">
                                                              <input type="password" name="npwd-<?= $entry['id'];?>" id="npwd-<?= $entry['id'];?>" value="" data-mini="true" />
                                                            </div>
                                                       </td>
                                                    </tr>
                                                </table>
                                            ...
                                            <td >
                                                <table width="100%">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div data-mini="true" data-role="fieldcontain">
                                                              <input type="password" name="cnpwd-<?= $entry['id'];?>" id="cnpwd-<?= $entry['id'];?>" value="" data-mini="true" />
                                                            </div>
                                                       </td>
                                                    </tr>
                                                </table>
                                    ...
                                    <div id="mess-<?= $entry['id'];?>"></div>
                                    <a href="#" data-role="button" data-rel="static" data-inline="true" name="changepwdbtn-<?= $entry['id'];?>" id="<?= $entry['id'];?>" data-icon="check"> Change</a>  
                                    <a href="#" data-role="button" data-inline="true" name="changeCancel" data-icon="check" >Cancel</a>      
                                </div>
                                <div data-role="content" id="successdiv-<?= $entry['id'];?>"  style="display:none" class="ui-corner-top ui-corner-bottom ui-content ui-body-b">
                                    <h1>Success!</h1>
