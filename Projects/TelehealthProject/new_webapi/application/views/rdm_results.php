<div data-role="page" id="results">
				...
				$.ajax({
				  ...
				  //				  	
					...
					if ('1'==msg){
						...
						// error control here $("#txtEmail").attr('data-theme','b').trigger('refresh');
					};
				});
			});
		});
	...
	<div data-mini="true" data-role="header" data-id="foo1" data-theme="b" data-position="fixed">
        <a href="<?= BASE_APP_URL;?>redimed/results" data-role="button"  data-icon="back" data-ajax="false">Back</a>
	...
	<div data-role="content">	
		<h2>Entries for <?= $name;?>.</h2>
  		<table width="100%" cellpadding="10px;">
        	<tr>
            	<td width="250px" valign="top"  style="padding-top: 28px;">
                	<ul data-role="listview" data-inset="true" data-filter="true">
						<?php foreach($results as $key => $entry) : ?>	
                                    <li data-theme="<?= ($entryId==$entry['id'])?"b":"d";?>" id="entrylist-<?= $entry['id'];?>" name="entrylist-<?= $entry['id'];?>">
                                            
                                        <a href="<?= BASE_APP_URL;?>redimed/detail/<?= $employeeId.'/'.$entry['id'];?>" name="entry-<?= $entry['id'];?>" id="<?= $entry['id'];?>">
                                            <?php if (2==$entry['status']): ?>			
                                            ...
                                            <?= date("M j Y ", strtotime($entry['createdTime']));?>
                                            
                                            <?php if (1==$entry['detail']['itype']): ?>			
                                                - General illness
                                            <?php else: ?>
                                                - Injury
                                            <?php endif; ?>
                ...
                <div data-role="actionsheet" class="ui-actionsheet-content ui-corner-top ui-corner-bottom" id="functions" data-theme="b">
                    <div data-role="content" class="ui-corner-top ui-corner-bottom ui-content ui-body-b">
                        ...
                        <a href="<?= BASE_APP_URL;?>redimed/assess/<?= $entryId;?>/1" data-role="button" data-ajax="false">First Certificate</a>  
                        <a href="<?= BASE_APP_URL;?>redimed/assess/<?= $entryId;?>/2" data-role="button" data-ajax="false">Progress Certificate</a>
                        <a href="<?= BASE_APP_URL;?>redimed/assess/<?= $entryId;?>/3" data-role="button" data-ajax="false">Final Certificate</a> 
                    </div>
                </div>
                <div data-role="collapsible" data-theme="d" data-content-theme="d" data-collapsed-icon="arrow-r" data-expanded-icon="arrow-d" data-mini="true" data-collapsed="true">
