//
//  rteleDoctorFormViewController.h
//  telehealth
//
...
@interface rteleDoctorFormViewController : LandscapeOnlyUIViewController <UIImagePickerControllerDelegate, UINavigationControllerDelegate, UIPopoverControllerDelegate>{
